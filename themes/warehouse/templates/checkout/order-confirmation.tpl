        ...
        <div class="col-sm-12 col-md-5 order-confirmation-details">
          ...
          {block name='order_details'}
            <div id="order-details">
              ...
              {* Custom: IDs pp_ref / pp_amount lus par le tracking GTM (format identique a l'ancien module PayPlug) *}
              <span id="pp_ref" style="display:none">{$order.details.reference}</span>
              <span id="pp_amount" style="display:none">{$order.totals.total.amount|number_format:2:",":""} €</span>
            </div>
          {/block}
