...
{block name='head_charset'}
  <meta charset="utf-8">
{/block}
{* Custom: preconnect Google Fonts — etablit les connexions TLS en avance, gain ~100-300ms sur le premier rendu du texte *}
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
{* Custom 2026-06-06: preload banniere retire — en 4G lente il volait la bande passante au CSS bloquant (FCP 2,4s -> 6s). L'image n'est plus lazy, c'est suffisant. *}
