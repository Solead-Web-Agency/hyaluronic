...
<div class="product-description">
 ...
 <span class="current-price"><span itemprop="price" class="product-price" content="{$product.rounded_display_price}">{l s='%price% tax excl.' d='Shop.Theme.Catalog' sprintf=['%price%'=> Tools::displayPrice($product.price_tax_exc)]}</span></span>{/if}
                    {if $product.has_discount && ((int)$product.price_amount == (int)$product.price_tax_exc)}
            ...
            {if $rounded_price_amount != $rounded_price_tax_exc}
                 <a href="{$product.url}"><span  class="product-price" content="{$product.price_amount}">{$product.price}  {$product.labels.tax_long}</span>{if $product.has_discount}
                    {hook h='displayProductPriceBlock' product=$product type="old_price"}
                    <span class="regular-price text-muted">{$product.regular_price}</span>{/if}
				 <div class="product-prices"> <p class="product-without-taxes"> {l s='%price% tax excl.' d='Shop.Theme.Catalog' sprintf=		['%price%'=> Tools::displayPrice($product.price_tax_exc)]}</p></div>
			{/if}
