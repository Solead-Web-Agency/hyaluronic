                ...
                <div class="panel clearfix">
                    ...
                    <div class="form-wrapper" style="padding-bottom: 40px;padding-top: 10px;">
                        <div class="form-group col-lg-12">
                                    ...
                                    <label class="control-label"> 
                                        <span class="label-tooltip"
                                            ...
                                            data-original-title="{l s='Fulfill it to convert << authorized amount >> for PLT option if you don\'t have any Dollar currency into your << location/currency menu >> ' mod='dhlexpress'}">
                                             {l s='Conversion rate from ' mod='dhlexpress'} {$default_currency|escape:'html':'UTF-8'} {l s='to USD  :' mod='dhlexpress'}
                                        </span>
                            ...
                            {/if}
                            <div class="col-lg-2">
                                <input type="text" id="conversion_rate_value" name="conversion_rate_value" value="{$conversion_rate_to_usd|floatval}">
                            </div>
