                  ...
                  {foreach $order_details as $order_detail}
                    <tr>
                      <td class="fixed-width-xl">
                        <input type="text"
                               value="{$order_detail.hs_code|escape:'html':'UTF-8'}"
                        ...
                        <select name="dhl_od_country_{$order_detail.id_order_detail|intval}"
                          ...
                          {foreach $countries as $country}
                            <option value="{$country.id_country|intval}"
                                    {if $country.id_country == $order_detail.default_country|intval}selected="selected"{/if}>{$country.name|escape:'html':'UTF-8'}</option>
                          {/foreach}
                        </select>
                      </td>
