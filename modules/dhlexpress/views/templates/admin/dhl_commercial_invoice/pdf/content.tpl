...
<table style="border: 0.5px solid black; font-size: 7pt; height: 300px;">
  ...
  <tr>
    ...
    <td colspan="4" style="height: 25px; border: 0.5px solid black;">
      <br/><br/>{l s='Total Declared Value: ' mod='dhlexpress'}{$invoice_vars.declared_value|string_format:'%.2f'} {$invoice_vars.currency_code|escape:'html':'UTF-8'|upper}
      {if $invoice_vars.reduction_amount}<br/><br/>{l s='Reduction amount: ' mod='dhlexpress'}{$invoice_vars.reduction_amount|string_format:'%.2f'}{/if}</td>
