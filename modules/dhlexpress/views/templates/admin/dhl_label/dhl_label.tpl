        ...
        <form id="create-label"
          ...
          <div class="form-group form-group-declared-value">
            <label class="control-label col-lg-3" for="dhl-label-declared-value">
                {l s='Total Goods Value' mod='dhlexpress'}
            </label>
            ...
            <div class="col-lg-3">
              <div class="input-group input fixed-width-md">
                ...
                <input type="text"
                       ...
                       onchange="inputValueControl(this.name);"
         ...
         {if isset($show_shipping) && $show_shipping }
          <div class="form-group">
            <label class="control-label col-lg-3">
                {l s='Shipping Cost' mod='dhlexpress'}
            </label>
            ...
            <div class="col-lg-3">
              <div class="input-group input fixed-width-md">
                ...
                <input type="text"
                       oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                       onchange="inputValueControl(this.name);"
                       name="dhl_label_shippig_cost_value"
                       id="dhl_label_shippig_cost_value"
                       value="{$shipping_cost_without_taxes}"
                       class="input fixed-width-sm">
              </div>
              {if isset($shipping_cost_without_taxes)}
                  <p class="help-block">
                      {l s='Shipping Cost (tax excl.)' mod='dhlexpress'} {*{$currency_iso|escape:'html':'UTF-8'} {$shipping_cost_without_taxes|floatval|string_format:'%.2f'}*}
                  </p>
              {/if}
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-lg-3">
              <div class="input-group input fixed-width-md">
                <span class="input-group-addon">{$currency_iso|escape:'html':'UTF-8'}</span>
                <input type="text"
                       name="dhl_label_total_value"
                       id="dhl-label-total-value"
                       value="{if isset($total_order) && $service_plt != -1}{$total_order|floatval|string_format:'%.2f'}{/if}"
                       class="input fixed-width-sm"
                       disabled>
              </div>
              {if isset($total_order)}
                  <p class="help-block">
                      {l s='Declared value (tax excl.)' mod='dhlexpress'}
                  </p>
              {/if}
            </div>
          </div>
