...
- Change request urls from http to https
...
## [2.5.7] - 2023-01-11
### Fixed
- Fix create custom product table issue

## [2.5.6] - 2022-10-19
### changed
- Country name for TVA and EORI

## [2.5.5] - 2022-10-18
### Fixed
- Fix Number of packages on the manifest
- Add discounts on dhl invoices

### Added
- Add VAT, UK VAT and EORI fields on the invoice
- Add HS Code and origin country on product configuration
- Add the signature image field on the invoice
