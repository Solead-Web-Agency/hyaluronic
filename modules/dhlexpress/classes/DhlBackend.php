...
class DhlBackend extends Dhlexpress
{
    ...
    public function getAccountSettingsForm()
    {
        ...
        $logName .= Tools::hash(_PS_MODULE_DIR_.$this->name.'/logs/').'.log';
            ...
            'form' => array(
                ...
                'input'  => array_merge(
                    array(
                        ...
                        array(
                            'type'             => 'switch',
                            'form_group_class' => 'dhl-use-weight-package-div',
                            'label'            => $this->l('A single package for all the items', 'DhlBackend'),
                            'name'             => 'DHL_USE_WEIGHT_PACKAGE',
                            'hint'             => $this->l('Single package including the sum of the dimensions & weight of the items', 'DhlBackend'),
                            'is_bool'          => true,
                            'values'           => array(
                                array(
                                    'id'    => 'active_on',
                        ...
                        array(
                            'type'             => 'switch',
                            'form_group_class' => 'dhl-use-weight-product-div',
                            'label'            => $this->l('One package per item', 'DhlBackend'),
                            'name'             => 'DHL_USE_WEIGHT_PRODUCT',
                            'hint'             => $this->l('Price calculated according to the rule 1 item = 1 package', 'DhlBackend'),
                            'is_bool'          => true,
                            'values'           => array(
                                array(
                                    'id'    => 'active_on',
        ...
        $forms['invoice'] = array(
            'form' => array(
                ...
                'input'  => array(
                    ...
                    array(
                        'type'     => 'select',
                        'label'    => $this->l('Defaul Origin Country', 'DhlBackend'),
                        'name'     => 'DHL_DEFAULT_ORIGIN_COUNTRY',
                        'options'  => array(
                            'query' => Country::getCountries((int) Context::getContext()->cookie->id_lang),
                            'id'    => 'id_country',
                            'name'  => 'name',
                    ...
                    array(
                        'type'    => 'switch',
                        'label'   => $this->l('Show shipping cost on invoice', 'DhlBackend'),
                        'name'    => 'DHL_INVOICE_SHIPPING_COST',
                        'is_bool' => true,
                        'values'  => array(
                            array(
                                'id'    => 'active_on',
