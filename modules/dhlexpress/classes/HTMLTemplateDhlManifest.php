...
class HTMLTemplateDhlManifest extends HTMLTemplate
{
    ...
    public function getHeader()
    {
        ...
        $dhlAccountCountryIso = Country::getIsoById((int) Configuration::get('DHL_ACCOUNT_OWNER_COUNTRY'));
        $dhlAccountCountryName = Country::getNameById(
            $this->context->language->id,
            (int) Configuration::get('DHL_ACCOUNT_OWNER_COUNTRY')
        );
        $shopDetails = array(
            ...
            'state'          => $stateName,
            'dhlcountryiso'  => $dhlAccountCountryIso,
            'dhlcountryname' => $dhlAccountCountryName,
        );
    ...
    public function getFooter()
    {
        ...
        foreach ($this->dhlManifest->shippingDetails as $shippingDetail) {
            ...
            $totalWeight += (float) $shippingDetail['total_weight'];
        }
        $this->context->smarty->assign(
            array(
