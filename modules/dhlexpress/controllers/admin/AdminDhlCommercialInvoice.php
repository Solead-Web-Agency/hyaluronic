...
class AdminDhlCommercialInvoiceController extends ModuleAdminController
{
    ...
    public function ajaxProcessGenerateInvoice()
    {
        ...
        if ($cartRules) {
            $order_reduction_amount = ($order->total_discounts_tax_excl - $shipping_tax_amount);
            $totalDeclaredValue = $totalDeclaredValue - $order_reduction_amount;
        }
        ...
        $dhlCI->invoiceVars = array(
            ...
            'reduction_amount' => $cartRules ? number_format($order_reduction_amount, 2) : '',
        );
