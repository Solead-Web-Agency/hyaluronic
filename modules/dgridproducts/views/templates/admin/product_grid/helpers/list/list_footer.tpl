                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="#" onclick="javascript:checkDelBoxes($(this).closest('form').get(0), '{$list_id}Box[]', true);return false;">
                            <i class="icon-check-sign"></i>&nbsp;{l s='Select all' mod='dgridproducts'}
                        </a>
                    </li>
                    <li>
                        <a href="#" onclick="javascript:checkDelBoxes($(this).closest('form').get(0), '{$list_id}Box[]', false);return false;">
                            <i class="icon-check-empty"></i>&nbsp;{l s='Unselect all' mod='dgridproducts'}
                        </a>
                    </li>
                    <li class="divider"></li>
    ...
    {if !$simple_header && $list_total > $pagination[0]}
        <div class="col-lg-6">
            ...
            <div class="pagination">
                ...
                / {$list_total} {l s='result(s)' mod='dgridproducts'}
            ...
            <ul class="pagination pull-right">
                ...
                <li>
                    <input class="jump-to-page fixed-width-xs float-left" style=" margin: 0; margin-left: -1px;" type="text">
                </li>

                <li class="hidden">
                    <a href="javascript:void(0);" class="pagination-link jump-to-page-link" data-page="1" data-list-id="{$list_id}">Перейти</a>
                </li>
