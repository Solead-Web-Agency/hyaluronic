...
<script>
    ...
    var snap_the_child_categories = "{l s='snap_the_child_categories' mod='dgridproducts'}";
    var only_default = "{l s='only_default' mod='dgridproducts'}";
		...
		<div class="wrap_snap_category">
			<div>
				<label class="control-label">
					<input class="form-group" type="checkbox" id="bind_child" /> {l s='Snap the child categories' mod='dgridproducts'}
				</label>
				<span onclick="snapTheChildCategories()" class="help-box"></span>
			</div>
			<div>
				<label class="control-label">
					<input class="form-group" type="checkbox" id="search_default_categories"{if Tools::getValue('search_default_categories')} checked{/if} /> {l s='Only default' mod='dgridproducts'}
				</label>
