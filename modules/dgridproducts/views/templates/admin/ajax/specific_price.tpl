...
<div class="content_form p_{$ps_version|replace:'.':''|escape:'quotes':'UTF-8'}">
	...
	<form id="form_specific_price" style="display: none;">
		...
		<div class="form_row">
			<label for="sp_from_quantity">{l s='Starting at' mod='dgridproducts'}</label>
			<div>
				<div class="col_half">
					<div class="input-group fixed-width-xxl ">
		...
		<div class="form_row">
			...
			<div>
				<div class="col_full">
					...
					<div class="sp_final_price fixed-width-xxl float-left">{l s='Final price' mod='dgridproducts'}: {displayPrice price=$product_price}</div>
					...
					<label class="float-left control-label" for="leave_bprice">
                        ...
                        {l s='Leave base price' mod='dgridproducts'}
					</label>
		...
		<div class="form_row">
			...
			<div class="clearfix col_full">
				...
				<select class="custom-select fixed-width-xxl float-left mr-1" name="sp_reduction_tax" id="sp_reduction_tax">
					<option value="0">{l s='Tax excluded' mod='dgridproducts'}</option>
					<option value="1">{l s='Tax included' mod='dgridproducts'}</option>
				</select>
		...
		<div class="form_row">
			<button class="button btn btn-default close_form_popup" href="#">
				{l s='Close' mod='dgridproducts'}</button>
