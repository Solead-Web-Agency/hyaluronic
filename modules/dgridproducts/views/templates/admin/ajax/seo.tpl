...
<div id="product-seo" class="panel product-tab {if $ps_version < 1.6}v15{/if}">
  ...
  <div class="form-group">
    ...
    {/if}
    <label class="control-label col-lg-3" for="meta_title_{$id_lang|intval}" title="{l s='Public title for the product\'s page, and for search engines. Leave blank to use the product name.' mod='dgridproducts'} {l s='The number of remaining characters is displayed to the left of the field.' mod='dgridproducts'}">
  ...
  <div class="form-group">
    ...
    {/if}
    <label class="control-label col-lg-3" for="meta_description_{$id_lang|intval}" title="{l s='This description will appear in search engines. You need a single sentence, shorter than 160 characters (including spaces).' mod='dgridproducts'}">
  ...
  <div class="form-group hide">
    ...
    {/if}
    <label class="control-label col-lg-3" for="meta_keywords_{$id_lang|intval}" title="{l s='Keywords for search engines, separated by commas.' mod='dgridproducts'}">
  ...
  <div class="form-group">
    ...
    {/if}
    <label class="control-label col-lg-3" for="link_rewrite_{$id_lang|intval}" title="{l s='This is the human-readable URL, as generated from the product\'s name. You can change it if you want.' mod='dgridproducts'}">
  ...
  <div class="form-group">
      ...
      <div class="col-lg-9">
          <button type="button" class="btn btn-default float-left" id="generate-friendly-url" onmousedown="updateFriendlyURLByName();">
              <i class="icon-random"></i> {l s='Generate' mod='dgridproducts'}</button>
      </div>
  </div>
  <div class="row">
  ...
  <div class="panel-footer">
    <button href="#" class="btn btn-default btn-lg close_form_seo"> {l s='Cancel' mod='dgridproducts'}</button>
    <button type="submit" name="submitAddproduct" class="btn btn-primary btn-lg pull-right saveSeo">{l s='Save' mod='dgridproducts'}</button>
  </div>
</div>
