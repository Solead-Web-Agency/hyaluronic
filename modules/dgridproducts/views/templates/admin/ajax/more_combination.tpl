...
<div class="panel form_edit_attributes">
    ...
    <div class="form-group form-group-custom">
        ...
        <label class="control-label col-lg-2" for="attribute_minimal_quantity">
            <span title="{l s='The minimum quantity to buy this product (set to 1 to disable this feature).' mod='dgridproducts'}">
        ...
        <label class="control-label col-lg-2" for="low_stock_threshold">
            {l s='Low stock level' mod='dgridproducts'}
        </label>
        ...
        <div class="col-lg-2">
            <div class="input-group fixed-width-xl">
                ...
                <input class=""
                       type="number"
                       maxlength="6"
                       placeholder="{l s='Leave empty to disable' mod='dgridproducts'}"
    ...
    <div class="row">
        <div class="col-lg-12">
            <button class="btn btn-default btn-lg cancelEditAttributes"
                    type="button">{l s='Cancel' mod='dgridproducts'}</button>
            <button class="btn btn-primary btn-lg saveMoreCombination"
                    type="button">{l s='Save' mod='dgridproducts'}</button>
        </div>
    </div>
</div>
<script>
