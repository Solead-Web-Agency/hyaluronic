                ...
                <div class="margin-form">
                    ...
                    {if isset($fields_value[$input.name].image) && $fields_value[$input.name].image}
                        <div id="image">
                            ...
                            <p align="center">{l s='File size' mod='dgridproducts'} {$fields_value[$input.name].size}{l s='kb' mod='dgridproducts'}</p>
                            <a href="{$current}&{$identifier}={$form_id}&token={$token}&deleteImage=1">
                                <img src="../img/admin/delete.gif" alt="{l s='Delete' mod='dgridproducts'}" /> {l s='Delete' mod='dgridproducts'}
                            </a>
                        </div><br />
                    {/if}
                    {/if}
                        ...
                        <select name="{$key}" class="{if isset($input.class)}{$input.class}{/if}">
                            ...
                            {if $key == 'months'}
                                ...
                                {foreach $select as $k => $v}
                                    <option value="{$k}" {if $k == $fields_value[$key]}selected="selected"{/if}>{l s=$v mod='dgridproducts'}</option>
                                {/foreach}
                            {else}
                                {foreach $select as $v}
