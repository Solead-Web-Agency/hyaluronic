...
<div class="bootstrap custom_bootstrap">
	...
	<div class="form_combinations" style="display: none;">
		...
		<div class="panel-footer">
			<div class="add_combinations" >
				...
				<button class="button btn btn-default btn-lg close_form_combinations pull-right" href="#">{l s='Close' mod='dgridproducts'}</button>
			</div>
		</div>
		...
		<div class="form_create_combination form_cc" style="display: none;">
			<form id="form_create_combination">
				...
				<div class="row">
					<div class="col-md-12">
                        <button class="btn btn-default btn-lg cancelCreateCombination" type="reset">{l s='Cancel' mod='dgridproducts'}</button>
                        <button class="btn btn-primary btn-lg createCombination" type="button">{l s='Save' mod='dgridproducts'}</button>
					</div>
				</div>
			</form>
		</div>
		...
		<div>
			<div>
				<div style="margin-bottom: 10px;">
					...
					<a class="button btn btn-default close_form_images" href="#" onclick="window.location.reload(true)">{l s='Close' mod='dgridproducts'}</a>
				</div>
	...
	<div class="form_location panel " style="display: none;">
		<div class="title_location">
			...
			<h3>{l s='Edit stock location' mod='dgridproducts'}</h3>
		</div>
