...
{
    public const TRANSLATIONKEY = 'amazonpayadminconfigformhelper';
    ...
    public static function renderForm($module)
    {
        ...
        foreach (self::getConfigForms($module) as $formKey => $formVars) {
            $forms[$formKey] = $helper->generateAmazonForm($module->getVar('context')->smarty, [$formVars]);
        }
            ...
            'form' => [
                ...
                'input' => [
                    ...
                    [
                        ...
                        'options' => [
                            'query' => [
                                ['key' => 'on_order', 'name' => 'On order'],
                                ['key' => 'on_shipment', 'name' => 'On shipment'],
                                ['key' => 'manual', 'name' => 'Manual capture'],
                            ],
                            'id' => 'key',
                            'name' => 'name',
                        ],
            ...
            'form' => [
                ...
                'input' => [
                    [
                        ...
                        'options' => [
                            'query' => [
                                ['key' => '0', 'name' => 'Disable logging completely'],
                                ['key' => '1', 'name' => 'Only errors'],
                                ['key' => '2', 'name' => 'Log errors and informations'],
                                ['key' => '3', 'name' => 'Debug mode'],
                            ],
                            'id' => 'key',
                            'name' => 'name',
                        ],
                    ...
                    */
                    [
                        ...
                        'options' => [
                            'query' => [
                                ['key' => '1', 'name' => 'Synchronous (default)'],
                                ['key' => '0', 'name' => 'Optimized'],
                            ],
                            'id' => 'key',
                            'name' => 'name',
                        ],
