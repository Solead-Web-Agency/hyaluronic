...
class AmazonPayHelper
{
     ...
     * @param Product|array|false $params
     *
     * @return bool
     *
    ...
    {
        try {
            if (isset(Context::getContext()->currency, Context::getContext()->currency->id)) {
    ...
    {
        if ($toCheckout) {
            $signInReturnUrl = Context::getContext()->link->getModuleLink('amazonpay', 'processlogin', ['toCheckout' => '1']);
        } else {
