...
class AmazonPaySimplePathHelper
{
    ...
    {
        return str_replace(['http://', 'https://'], '', $this->context->link->getModuleLink('amazonpay', 'ipn', []));
    }
    ...
    {
        return str_replace('http://', 'https://', $this->context->link->getModuleLink('amazonpay', 'keyshare', []));
    }

    /**
     * @param string|false $joined
     * @return array|string
     */
    protected function getAllowedReturnUrls($joined = false)
    {
        ...
        foreach ($language_ids as $id_lang) {
            $url = str_replace('http://', 'https://', $this->context->link->getModuleLink('amazonpay', 'initcheckout', [], null, (int) $id_lang));
