...
class AmazonPayTransaction extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields' => [
            'amazon_checkout_session' => ['type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => false, 'size' => 255],
            'amazon_transaction' => ['type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => false, 'size' => 255],
            'transaction_type' => ['type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => false, 'size' => 16],
            'transaction_amount' => ['type' => self::TYPE_FLOAT, 'required' => false],
            'transaction_reference' => ['type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => false, 'size' => 255],
