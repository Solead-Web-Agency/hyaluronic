...
class AmazonPayIPNHandler
{
    ...
    public function __construct()
    {
        try {
            ...
            if (isset($this->data[AmazonPayDefinitions::IPN_MERCHANT_ID], $this->data[AmazonPayDefinitions::IPN_OBJECT_TYPE], $this->data[AmazonPayDefinitions::IPN_OBJECT_ID], $this->data[AmazonPayDefinitions::IPN_NOTIFICATION_TYPE], $this->data[AmazonPayDefinitions::IPN_NOTIFICATION_ID], $this->data[AmazonPayDefinitions::IPN_NOTIFICATION_VERSION])
            ) {
