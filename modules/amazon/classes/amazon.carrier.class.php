...
class AmazonCarrier
{
    ...
    public static function getAmazonCarrierByPsIdCarrier($id_carrier, $id_lang)
    {
        ...
        foreach ($outgoingMapping[$id_lang] as $mapping) {
            ...
            if ($id_carrier && $ps_mapping_id && $id_carrier === $ps_mapping_id) {
                $carrier = $mapping['custom_carrier'] ?: $mapping['amazon'];
                $method = $mapping['custom_method'] ?: $mapping['shipping_service'];
