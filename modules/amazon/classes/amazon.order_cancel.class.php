...
class AmazonOrderCancel extends Amazon
{
    ...
    const CANNOT_VERIFY_INFORMATION = 11;
    const PRICING_ERROR = 12;
    const REJECT_ORDER = 13;
    const WEATHER_DELAY = 14;

    public static $reasons = array(
        self::NO_INVENTORY => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_NO_INVENTORY,
        self::SHIPPING_ADDRESS_UNDELIVERABLE => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_ADDRESS_UNDELIVERABLE,
        self::CUSTOMER_EXCHANGE => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_CUSTOMER_EXCHANGE,
        self::BUYER_CANCELED => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_BUYER_CANCELLED,
        self::GENERAL_ADJUSTMENT => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_GENERAL_ADJUSTMENT,
        self::CARRIER_CREDIT_DECISION => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_CARRIER_CREDIT_DECISION,
        self::RISK_ASSESSMENT_INFORMATION_NOT_VALID => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_RISKY,
        self::CARRIER_COVERAGE_FAILURE => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_CARRIER_COVERAGE_FAILURE,
        self::CUSTOMER_RETURN => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_CUSTOMER_RETURN,
        self::MERCHANDISE_NOT_RECEIVED => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_MERCHANDISE_NOT_RECEIVED,
        self::CANNOT_VERIFY_INFORMATION => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_CANNOT_VERIFY_INFORMATION,
        self::PRICING_ERROR => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_PRICING_ERROR,
        self::REJECT_ORDER => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_REJECT_ORDER,
        self::WEATHER_DELAY => AmazonSPFeedMessageOrderAcknowledgementCancelItem::REASON_WEATHER_DELAY,
    );
    public static $available_reasons = array(
        self::NO_INVENTORY,
        self::SHIPPING_ADDRESS_UNDELIVERABLE,
        self::CUSTOMER_EXCHANGE,
        self::BUYER_CANCELED,
        self::GENERAL_ADJUSTMENT,
        self::CARRIER_COVERAGE_FAILURE,
    ...
    public function getOrders($id_lang_list, $delay = 3)
    {
        ...
        if (AmazonTools::tableExists(_DB_PREFIX_.Amazon::TABLE_MARKETPLACE_ORDERS)) {
            $sql = 'SELECT o.`id_order`, mp.`mp_order_id`, mp.marketplace_id FROM `'._DB_PREFIX_.'orders` o
