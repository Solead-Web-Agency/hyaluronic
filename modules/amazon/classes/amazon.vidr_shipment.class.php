...
class AmazonVIDRShipment
{
    ...
    const PROCESS_STATUS_SAVE_PDF_FAILED = 61;
    ...
    //alternative VAT related fields
    const RP_BUYER_TAX_REGISTRATION_ID = 'buyer-tax-registration-id';
    const RP_BUYER_TAX_REGISTRATION_COUNTRY = 'buyer-tax-registration-country';
    const RP_BUYER_TAX_REGISTRATION_TYPE = 'buyer-tax-registration-type';
    const RP_BUYER_COMPANY_NAME = 'buyer-company-name';
    ...
    public static function getMarketplaceIso($mkpId, $exc = true)
    {
        switch ($mkpId) {
            case AmazonSellerPartnerConstant::MKP_FR:
                return self::MARKETPLACE_FR;
            case AmazonSellerPartnerConstant::MKP_ES:
                return self::MARKETPLACE_ES;
            case AmazonSellerPartnerConstant::MKP_DE:
                return self::MARKETPLACE_DE;
            case AmazonSellerPartnerConstant::MKP_IT:
                return self::MARKETPLACE_IT;
            case AmazonSellerPartnerConstant::MKP_UK:
                return self::MARKETPLACE_UK;    // Amazon report use `gb` for UK
            case AmazonSellerPartnerConstant::MKP_NL:
                return self::MARKETPLACE_NL;
            case AmazonSellerPartnerConstant::MKP_SE:
                return self::MARKETPLACE_SE;
            case AmazonSellerPartnerConstant::MKP_PL:
                return self::MARKETPLACE_PL;
            case AmazonSellerPartnerConstant::MKP_BE:
                return self::MARKETPLACE_BE;
            default:
                if ($exc) {
                    throw new Exception("Unknown marketplace: $mkpId");
                } else {
                    return '';
                }
    ...
    public static function getUnfinishedShipments($marketplace, $limit)
    {
        ...
        $statusITNoneBusinessOrder = AmazonConfiguration::get(AmazonConstant::CONFIG_MKP_IT_VCS_ALLOW_UPLOAD_NON_BIZ_INVOICE) ? AmazonVIDRShipment::PROCESS_STATUS_IT_NON_BUSINESS_ORDER : 0;
