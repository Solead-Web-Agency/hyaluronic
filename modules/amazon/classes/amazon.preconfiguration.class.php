...
class AmazonPreconfiguration
{
    public static $preconfiguration = array(
        'de' => array(
            ...
            '_amazon_prime_carrier' => 'Std DE Dom',
        ),
        'es' => array(
            'region' => 'es',
            'currency' => 'EUR',
            ...
            '_amazon_prime_carrier' => 'Std ES Dom',
        ),
        'fr' => array(
            'region' => 'fr',
            'currency' => 'EUR',
            ...
            '_amazon_prime_carrier' => 'Std FR Dom',
        ),
        'it' => array(
            'region' => 'it',
            'currency' => 'EUR',
            ...
            '_amazon_prime_carrier' => 'Std IT Dom',
        ),
        'gb' => array(
            'region' => 'uk',
            'currency' => 'GBP',
            ...
            '_amazon_prime_carrier' => 'Std UK Dom',
        ),
        'us' => array(
            'region' => 'us',
            'currency' => 'USD',
            ...
            '_amazon_prime_carrier' => 'Std US Dom',
        ),
        'mx' => array(
            'region' => 'mx',
            'currency' => 'MXN',
            ...
            'taxes' => true,
            'marketplace_master' => null,
            '_amazon_prime_carrier' => 'Std MX Dom',
        ),
        'ca' => array(
            'region' => 'ca',
            'currency' => 'CAD',
            ...
            'taxes' => false,
            'marketplace_master' => null,
            '_amazon_prime_carrier' => 'Std CA Dom',
        ),
        'sa' => array(
            'region' => 'sa',
            'currency' => 'SAR',
            '_amazon_incoming_carrier' => '',
            '_amazon_outgoing_carrier' => '',
            'synchronization_field' => 'upc',
            'taxes' => false,
            'marketplace_master' => null,
            '_amazon_prime_carrier' => '',
        ),
        'se' => array(
            'region' => 'se',
            'currency' => 'SEK',
    ...
    public static function data($id_lang)
    {
        ...
        $preconfiguration_data['incoming_carriers'] = array(
            0 => array(
                'amazon_carrier' => $preconfiguration_data['_amazon_incoming_carrier'],
                'carrier' => $preconfiguration_data['_carrier']
            )
        );
        ...
        $preconfiguration_data['prime_carriers'] = array(0 => md5($preconfiguration_data['_amazon_prime_carrier']));
        $preconfiguration_data['prestashop_prime_carrier'] = array(0 => $preconfiguration_data['_carrier']);
