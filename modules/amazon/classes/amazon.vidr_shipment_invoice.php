...
class AmazonVIDRShipmentInvoice
{
    ...
    {
        $mkpCode = Tools::strtolower($mkpCode);
        $this->context = $context;
        $this->shippingId = $shippingId;
        $this->mkpCode = $mkpCode;
        ...
        // Switch language context for translation
        $idLang = Language::getIdByIso($mkpCode);
        if ($idLang) {
...
//            'invoice_title' => $invoiceFormattedNumber,
    ...
    protected function buildFeedOptions($finalVatInclAmount, $totalTax, $firstMpOrderId, $isCreditNote)
    {
        ...
        $options = array(
            ...
            "metadata:orderId" => $firstMpOrderId,
        );
