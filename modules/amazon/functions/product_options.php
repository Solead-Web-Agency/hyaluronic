...
class ProductOptions extends Amazon
{
    ...
    public function doIt()
    {
      ...
      <div id="tabList">';
        ...
        foreach ($this->_languages as $language) {
            ...
            $html .= $this->_transparencycode($id_lang, $defaults['transparencycode']);
    ...
    private function _transparencycode($id_lang, $default)
    {
        $html = '
        <tr class="amazon-details amazon-item-title">
            <td class="col-left">'.$this->l('Transparency code').'</td>
            <td style="padding-bottom:5px;">
            <input type="text" name="amz-transparencycode-'.$id_lang.'" value="'.$default.'" style="width:40px" /><br />
            <span class="amz-small-line">'.$this->l('Transparency codes are affixed to the outer packaging of each individual unit of the product').'</span><br />
            <span class="amz-small-line">'.$this->l('Propagate this value to all products in this').' :
                            <a href="javascript:void(0)" id="amz-propagate-transparencycode-category-'.$id_lang.'" class="amz-propagate-transparencycode-cat amz-link">[ '.$this->l('Category').' ]</a>&nbsp;&nbsp;
                            <a href="javascript:void(0)" id="amz-propagate-transparencycode-shop-'.$id_lang.'" class="amz-propagate-transparencycode-shop amz-link">[ '.$this->l('Shop').' ]</a>&nbsp;&nbsp;
                            <a href="javascript:void(0)" id="amz-propagate-transparencycode-manufacturer-'.$id_lang.'" class="amz-propagate-transparencycode-manufacturer amz-link">[ '.$this->l('Manufacturer').' ]</a>&nbsp;&nbsp;
                            <a href="javascript:void(0)" id="amz-propagate-transparencycode-supplier-'.$id_lang.'" class="amz-propagate-transparencycode-supplier amz-link">[ '.$this->l('Supplier').' ]</a>&nbsp;&nbsp;
            </span>
            <span id="transparencycode-loader-'.$id_lang.'" style="display:none"><img src="'.$this->images.'green-loader.gif" style="margin-left:5px;position:relative;top:-8px" alt="" /></span>
            </td>
        </tr>
        ';
