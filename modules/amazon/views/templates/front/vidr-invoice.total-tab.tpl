...
<table id="total-tab" width="100%">
	...
	<tr>
		...
		<td class="white" width="50%">
			{if !$is_credit_note && $footer.shipping_tax_excl > 0 || $is_credit_note && $footer.shipping_tax_excl < 0}
    ...
    {* VIDR: Promotion is negative for SHIPMENT, positive for RETURN / REFUND *}
    {if !$is_credit_note && $footer.product_discounts_tax_excl < 0 || $is_credit_note && $footer.product_discounts_tax_excl > 0}
        <tr>
            <td class="grey" width="50%">
	...
	{if !$is_credit_note && $footer.total_taxes > 0 || $is_credit_note && $footer.total_taxes < 0}
	<tr class="bold">
		<td class="grey">
