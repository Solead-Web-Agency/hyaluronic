...
<div id="tabList" class="panel">
     ...
     <form action="#" id="amazonSyncOptions" name="amazonSyncOptions" method="POST">
         ...
         <fieldset class="panel">
             ...
             <table style="width:900px;" class="amz-options">
                 ...
                 <tr>
                     <td>
                         <input type="checkbox" value="1" class="extended_data_switch" data-lang_id="{$id_lang|intval}"
                         ...
                         <div class="form-group margin-form custom_extended_data-{$id_lang|intval}" style="display: none;">
                             <input type="radio" name="extended-datas-variant" id="extended-datas-variant"
                                    value="1" checked/><label for="extended-datas-variant-1" class="label-checkbox">{l s='All' mod='amazon'}</label>
                             <input type="radio" name="extended-datas-variant" id="extended-datas-variant"
                                    value="2" /><label for="extended-datas-variant-2" class="label-checkbox">{l s='Name and description' mod='amazon'}</label>
                             <input type="radio" name="extended-datas-variant" id="extended-datas-variant"
                                    value="3"/><label for="extended-datas-variant-3" class="label-checkbox">{l s='Features' mod='amazon'}</label>
                         </div>
                     </td>
                     <td>
                     ...
                     <td>
                         <input type="checkbox" value="1"
                                name="include-msrp"/><span>{l s='Include List Price' mod='amazon'}</span><br/>
                     </td>
                     <td>
                         <input type="checkbox" value="1"
                                name="no-price"/><span>{l s='No Price' mod='amazon'}</span><br/>
                     </td>
                 </tr>
                 <tr>
                     <td>
         ...
         {* Temporary disabled, because of this ticket: https://common-services-force.monday.com/boards/1971464818/views/42129804/pulses/4018458255 
             a better aproach could be to enable it for PS 1.4 only, as deprecated commented in functions/automaton.php: Only used in PS1.4- via ProductsAmazon
         *}
         {*
         {if $wizard_enabled}
             ...
             <fieldset class="panel">
                 ...
                 <table style="width:800px;" class="amz-options">
                     ...
                     <tr>
                         ...
                         <td>
                             <input type="checkbox" value="1" name="visibility-hidden" checked/><span>{l s='Hide product (switches visibilty to hidden)' mod='amazon'}</span><br/>
                         </td>
 ...
 <!-- Report Tab -->
 {include file=$tpl_path|escape:'quotes':'UTF-8'|cat:'views/templates/admin/ReportAmazon.tpl' type='product'}
</div>
