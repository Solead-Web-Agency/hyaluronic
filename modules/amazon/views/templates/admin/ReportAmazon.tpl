...
<div id="menudiv-report" class="tabItem" rel="report">
    <form action="#" id="amazonReportOptions" name="amazonReportOptions" method="POST">
        ...
        <div class="form-group">
            <div class="margin-form col-lg-offset-3">
                ...
                <input type="hidden" id="feed_result_url" value="{$feed_result_url|escape:'htmlall':'UTF-8'}"/>
                ...
                <div class="{$alert_class.error|escape:'htmlall':'UTF-8'} col-lg-12" id="reports-error"
                     style="display:none;"></div>
