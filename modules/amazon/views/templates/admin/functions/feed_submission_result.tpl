...
{if isset($feedSubmissionResultSummary)}
    <table class="submission-results-table">
        ...
        <tr>
            ...
            <td style="font-weight:bold;">{$feedSubmissionResultSummary->MessagesProcessed|escape:'html':'UTF-8'}</td>
        <tr>
        </tr>
        <tr>
            <td class="col1">{$feedSubmissionResultText4|escape:'html':'UTF-8'}</td>
            <td style="color:#1D910F;font-weight:bold;">{$feedSubmissionResultSummary->MessagesSuccessful|escape:'html':'UTF-8'}</td>
        </tr>
        <tr>
            <td class="col1">{$feedSubmissionResultText5|escape:'html':'UTF-8'}</td>
            <td style="color:#FD0000;font-weight:bold;">{$feedSubmissionResultSummary->MessagesWithError|escape:'html':'UTF-8'}</td>
        </tr>
        <tr>
            <td class="col1">{$feedSubmissionResultText6|escape:'html':'UTF-8'}</td>
            <td style="color:#FFA300;font-weight:bold;">{$feedSubmissionResultSummary->MessagesWithWarning|escape:'html':'UTF-8'}</td>
        </tr>
        <tr>
            <td class="col1">{$feedSubmissionResultText7|escape:'html':'UTF-8'}</td>
            <td>{$feedSubmissionResultTextError|escape:'html':'UTF-8'}{* Validation: can't escape *}</td>
        </tr>
        </tbody>
    </table>
{elseif isset($feedSubmissionResultIsError)}
    <table class="submission-results-table">
        ...
        <tr>
            ...
            <td style="color:#FFA300;font-weight:bold;">{$feedSubmissionResultObject->Error->Code|escape:'html':'UTF-8'}</td>
        </tr>
        <tbody>
        <tr>
            <td class="col1">{$feedSubmissionResultText7|escape:'html':'UTF-8'}</td>
...
{elseif isset($feedSubmissionResultObjectText)}
    {$feedSubmissionResultObjectText|escape:'html':'UTF-8'}
{/if}
