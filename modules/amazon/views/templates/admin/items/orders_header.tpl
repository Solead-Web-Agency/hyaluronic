...
<br/>
<span class="common-services">Amazon Marketplace for Prestashop by 
    <i><a href="http://blog.common-services.com/" title="Common-Services" target="_blank">Common-Services.com</a></i>
</span>
<br/><br/>
...
<form action="#" id="amazonParams" name="amazonParams" method="POST">
    ...
    <input type="hidden" id="import_enhancement_url" value="{$import_enhancement_url|escape:'htmlall':'UTF-8'}"/>
