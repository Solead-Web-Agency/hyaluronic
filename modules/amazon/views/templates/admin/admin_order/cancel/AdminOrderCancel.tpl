...
{include file=$template_path|cat:'cancel/admin_order_cancel_including.tpl'}

{if ($ps_version_is_16 || $ps_version_is_17)}
<div class="col-lg-7">
    <div class="panel">
        <fieldset id="amazon-order-ps16">
            ...
            <fieldset id="amazon-order-ps15" style="margin-top:10px;">
                ...
                <fieldset id="amazon-order-ps14" style="width:400px;margin-top:10px;">
                    ...
                    {include file=$template_path|cat:'cancel/admin_order_cancel_body.tpl'}
                </fieldset>
                {if ($ps_version_is_16 || $ps_version_is_17)}
    </div>
</div>
