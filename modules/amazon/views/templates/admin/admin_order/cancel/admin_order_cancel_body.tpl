...
{if $scenario == 'to_cancel'}
    <span class="amazon_text" style="color:red;font-weight:bold">{l s='Cancelation pending, please provide a reason' mod='amazon'}:</span>
    <br />
    <br />
    <div class="row">
        <div class="col-lg-9">
        ...
        <div class="col-lg-3">
            ...
            </button>&nbsp;&nbsp;<img src="{$images_url|escape:'quotes':'UTF-8'}loader-connection.gif"
                                      id="amazon-cancel-loader" style="display:none" />
        </div>
    </div>
{elseif $scenario == 'cancel_cancel'}
    <span class="amazon_text" style="color:red;font-weight:bold">{l s='Cancelation has been scheduled' mod='amazon'}</span>
    <br />
    <br />
    <div class="row">
        <div class="col-lg-3">
...
{elseif $scenario == 'canceled'}
    <span class="amazon_text" style="color:red;font-weight:bold">{l s='This order has been canceled' mod='amazon'}</span>
    <br />
    <br />
{/if}
...
<div class="margin-form">
    <div id="amazon-cancel-success" class="{$class_success|escape:'htmlall':'UTF-8'}" style="display:none"></div>
    <div id="amazon-cancel-error" class="{$class_error|escape:'htmlall':'UTF-8'}" style="display:none"></div>
</div>
