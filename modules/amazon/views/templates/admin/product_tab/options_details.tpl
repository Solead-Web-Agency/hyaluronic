    ...
    <div class="section">
        ...
        <div>
            <table class="amazon-datas">
                ...
                {if isset($product_tab.alternative_content) && $product_tab.alternative_content}
    ...
    <div class="section">
        ...
        <div>
            <table class="amazon-options">
                ...
                {include file="{$product_tab.module_path|escape:'quotes':'UTF-8'}/views/templates/admin/product_tab/items/transparency_code.tpl" data=$data['transparencycode']}
                ...
                {if isset($data['brand'])}
                    {include file="{$product_tab.module_path|escape:'quotes':'UTF-8'}/views/templates/admin/product_tab/items/brand.tpl" data=$data['brand']}
                {/if}

                {if isset($data['manufacturer'])}
                    {include file="{$product_tab.module_path|escape:'quotes':'UTF-8'}/views/templates/admin/product_tab/items/manufacturer.tpl" data=$data['manufacturer']}
                {/if}

                {if isset($data['product_tax_override'])}
                    {include file="{$product_tab.module_path|escape:'quotes':'UTF-8'}/views/templates/admin/product_tab/items/product_tax_override.tpl" data=$data['product_tax_override']}
                {/if}
            </table>
        </div>
    </div>
