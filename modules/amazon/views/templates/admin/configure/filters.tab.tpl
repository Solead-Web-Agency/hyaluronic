...
<div id="menudiv-filters" class="tabItem {if $filters.selected_tab}selected{/if} panel form-horizontal">
    ...
    <div class="form-group">
        <label class="control-label col-lg-3" style="color:grey">{l s='Status Filters' mod='amazon'}</label>
        <div class="margin-form col-lg-9">&nbsp;</div>

        <div align="left" class="margin-form col-lg-9">
            <span class="checkbox_config" style="color:#666">
                <input type="hidden"name="status_filter[prestashop_inactive]" value="0">
                <input type="checkbox" style="top:2px;" name="status_filter[prestashop_inactive]" value="1" {if $filters.statuses.prestashop_inactive}checked{/if}/>
                {l s='Inactive' mod='amazon'}
            </span>
            <span class="checkbox_config" style="color:#666">
                <input type="hidden"name="status_filter[zero_price]" value="0">
                <input type="checkbox" style="top:2px;" name="status_filter[zero_price]" value="1" {if $filters.statuses.zero_price}checked{/if}/>
                {l s='Zero price' mod='amazon'}
            </span>
        </div>
    </div>
