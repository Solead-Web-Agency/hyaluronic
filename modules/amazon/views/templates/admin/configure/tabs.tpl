...
<ul class="nav" id="menuTab">
    ...
    {foreach from=$tabs.platforms item=marketplace}
        ...
        <li id="menu-{$marketplace.iso_code|escape:'htmlall':'UTF-8'}"
            {if !$marketplace.display}style="display:none"{/if}
                {if $marketplace.iso_code == 'be'} rel="amazon-amazon-be" class="{$platformClass|cat:' amazon-amazon-be'}" {elseif ($marketplace.area == 'eu' && !$marketplace.display)}rel="amazon-europe" class="{$platformClass|cat:' amazon-europe'}"{elseif ($marketplace.area == 'ww' && !$marketplace.display)}rel="amazon-worldwide" class="{$platformClass|cat:' amazon-worldwide'|escape:'htmlall':'UTF-8'}"{else}class="{$platformClass|escape:'htmlall':'UTF-8'}"{/if}>
            <a href="#"><span>&nbsp;<img
    ...
    {if isset($tabs.prime)}
        <li id="menu-prime" class="amazon-prime menuTabButton {$tabs.prime_selected|escape:'htmlall':'UTF-8'}"
            rel="amazon-prime" style="display: none">
            <a href="#">
                <span>&nbsp;
                    <img src="{$tabs.images_url|escape:'quotes':'UTF-8'}tabs/prime.png"
                         title="{$tabs.prime|escape:'htmlall':'UTF-8'}"/>
                    &nbsp;{$tabs.prime|escape:'htmlall':'UTF-8'}
                </span>
            </a>
        </li>
    {/if}
