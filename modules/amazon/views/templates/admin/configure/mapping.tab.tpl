...
<div id="menudiv-mapping"
     class="tabItem {if $mapping.selected_tab}selected{/if} panel form-horizontal{if !$psIsGt15} ps15{/if}">
                                            ...
                                            {foreach from=$mapping_group.left key=index item=attribute}
                                                ...
                                                <span class="arrow">
                                                    ...
                                                    {if $mapping_group.has_valid_values}
                                                        ...
                                                        <option value="{$key|escape:'quotes':'UTF-8'}" {if $attribute.mapping == $key}selected{/if}>{$valid_value|escape:'htmlall':'UTF-8'}</option>
                                                    {/foreach}
                                                        </select>
                                                    {else}
                                            ...
                                            {foreach from=$mapping_group.left key=index item=feature_value}
                                                ...
                                                <span class="arrow">
                                                    ...
                                                    {if $mapping_group.has_valid_values}
                                                        ...
                                                        <option value=""></option>
                                                        {foreach from=$mapping_group.right key=key item=valid_value}
                                                        <option value="{$key|escape:'quotes':'UTF-8'}" {if $feature_value.mapping == $key}selected{/if}>{$valid_value|escape:'htmlall':'UTF-8'}</option>
                                                    {/foreach}
                                                        </select>
                                                    {else}
