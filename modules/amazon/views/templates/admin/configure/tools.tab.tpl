...
<div id="menudiv-tools" class="tabItem {if $tools.selected_tab}selected{/if} panel form-horizontal">
    ...
    <h4 class="valid-values-title">{l s='Amazon States Table' mod='amazon'}</h4>
    <span style="float:left;margin-left:15px;">{l s='List of valid states' mod='amazon'}</span><br/><br/>
    <div class="form-group">
        <div align="left" class="margin-form col-lg-offset-3">
            <div id="states-installation-success" class="{$class_success|escape:'htmlall':'UTF-8'}" style="display:none">
                <p>{l s='Install states successfully' mod='amazon'}</p>
            </div>
            <div id="states-installation-error" class="{$class_error|escape:'htmlall':'UTF-8'}" style="display:none"></div>
        </div>
    </div>
    <div align="left" class="margin-form col-lg-offset-3">
        <p class="{$class_info|escape:'htmlall':'UTF-8'}" id="states-installation-loader" style="display:none">
            {l s='Attempting to download and install states list from Amazon S3' mod='amazon'}... &nbsp;&nbsp;&nbsp;<img
                src="{$tools.images_url|escape:'quotes':'UTF-8'}loader-connection.gif" alt=""/>
        </p>
    </div>
    <div align="left" class="margin-form col-lg-offset-3">
        <input type="button" class="button btn float-right" id="tools_states_installation_button"
               value="{l s='Import override' mod='amazon'}"/>
        <br/>
    </div>
    <br/>
        ...
        <div rel="amazon-expert-mode" class="amazon-expert-mode" style="display:none">
            ...
            <div align="left" class="margin-form col-lg-offset-3">
                <table class="table table-maintenance">
                    ...
                    <tr>
                        <td>
                            {l s='Update Custom Definitions' mod='amazon'}
                        </td>
                        <td>
                            <input type="button" class="button btn float-right" id="maintenance-update-customs"
                                   value="{l s='Update' mod='amazon'}"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label rel="delete_logs"><span style="font-weight: normal;">{l s='Delete log files' mod='amazon'}</span></label>
                        </td>
                        <td>
                            <input type="button" class="button btn float-right" id="maintenance-delete-logs"
                                   value="{l s='Delete' mod='amazon'}"/>
                        </td>
                    </tr>
                    </tbody>
