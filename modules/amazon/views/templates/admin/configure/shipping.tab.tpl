...
<div id="menudiv-shipping" class="tabItem {if $shipping.selected_tab}selected{/if} panel form-horizontal">
    ...
    {/if}
        ...
        <div class="amazon-tab amazon-tab-{$marketplace.id_lang|escape:'quotes':'UTF-8'}"
            ...
            <div class="margin-form">
                <div class="amz-info-level-info {if $psIsGt15}alert alert-warning col-lg-offset-3{/if}" style="font-size:1.1em">
                    <ul>
                        <li>{l s='This feature is not available for Poland, Sweden and Netherlands' mod='amazon'}.</li>
                    </ul>
                </div>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="margin-form col-lg-9">
        <span class="switch prestashop-switch fixed-width-lg">
            <input type="radio" name="shipping[smart_shipping][active]" id="smart-shipping-active" value="1" class="smart-shipping-active"
                   {if $shipping.smart_shipping.active}checked{/if} /><label for="smart-shipping-active"
                                                                             class="label-checkbox">{l s='Yes' mod='amazon'}</label>
            <input type="radio" name="shipping[smart_shipping][active]" id="smart-shipping-active-2" value="0" class="smart-shipping-active"
    ...
    {if isset($shipping.smart_shipping.mapping)}
        <div id="smart-shipping" class="form-group" {if (!isset($shipping.smart_shipping.active) || ! $shipping.smart_shipping.active )}style="display:none;"{/if}>
            <label class="control-label col-lg-3" rel="kind_override"><span>{l s='Kind of Override' mod='amazon'}</span></label>
    ...
    {else}
        <div id="smart-shipping" class="form-group" style="{if !$shipping.smart_shipping.active}display: none;{/if}">
            <label class="control-label col-lg-3">&nbsp;</label>
