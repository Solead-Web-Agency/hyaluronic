    ...
    <div class="form-group">
        <div class="margin-form col-lg-offset-1 col-lg-11">
            <table class="feature-table">
                ...
                <tr class="features-items amazon-be {if (!$features.config.amazon_europe)} hide {/if}">
                    <td style="width:10%">
                        <input type="checkbox" name="features[amazon_be]" value="1"
                               {if ($features.config.amazon_be && $features.config.amazon_europe)}checked{/if} id="feat-amazon-be-cb"
                               class="regular-checkbox big-checkbox"><label for="feat-amazon-be-cb"></label>
                    </td>
                    <td style="width:30%">
                       <span>{l s='Amazon for ' mod='amazon'}BE<span>
                    </td>
                    <td style="width:60%">
                        {l s='Activate Amazon BE platform support' mod='amazon'}
                        <br/>
                        {$features.links.be|escape:'quotes':'UTF-8'}
                    </td>
                </tr>

                <tr class="features-items amazon-za {if (!$features.config.amazon_europe)} hide {/if}">
                    <td style="width:10%">
                        <input type="checkbox" name="features[amazon_za]" value="1"
                               {if (isset($features.config.amazon_za) && $features.config.amazon_za && $features.config.amazon_europe)}checked{/if} id="feat-amazon-za-cb"
                               class="regular-checkbox big-checkbox"><label for="feat-amazon-za-cb"></label>
                    </td>
                    <td style="width:30%">
                       <span>{l s='Amazon for ' mod='amazon'}ZA<span>
                    </td>
                    <td style="width:60%">
                        {l s='Activate Amazon ZA platform support' mod='amazon'}
                        {if isset($features.links.za)}
                            <br/>
                            {$features.links.za|escape:'quotes':'UTF-8'}
                        {/if}
                    </td>
                </tr>
                ...
                <tr class="features-items">
                    <td style="width:10%">
                        <input type="checkbox" name="features[business]" value="1" {if ($features.config.business)}checked{/if} {if (!$features.config.business && $features.config.noway)}disabled{/if}
                               ...
                               class="regular-checkbox big-checkbox{if (!$features.config.business && $features.config.noway)} noway{/if}">
                        <label for="feat-business-cb"></label>
                    </td>
                    <td style="width:30%">
                ...
                <tr class="features-items">
                    <td style="width:10%">
                        <input type="checkbox" name="features[prime]" value="1" id="feat-prime-cb"
                               {if (!$features.config.prime && $features.config.noway)}disabled{/if}
                               {if ($features.config.prime)}checked{/if}
                               class="regular-checkbox big-checkbox{if (!$features.config.prime && $features.config.noway)} noway{/if}">
                        <label for="feat-prime-cb"></label>
                    </td>
                    <td style="width:30%">
                        <span>{l s='Prime' mod='amazon'}</span>
                    </td>
                    <td style="width:60%">
                        {l s='Amazon Prime shipped by the merchant' mod='amazon'}
{*                        Recover document link after have one*}
                    </td>
                </tr>
                <!-- EXPERT MODE SECTION -->
                <tr class="features-section">
