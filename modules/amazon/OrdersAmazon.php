...
class OrdersAmazon extends AdminTab
{
    ...
    public function display()
    {
        ...
        if (version_compare(_PS_VERSION_, '1.6.1.2', '<')) {
            ...
            $this->addJS($this->url . 'views/js/orders.js?v=' . $this->_amazon->version);
            $this->addJS($this->url . 'views/js/reports.js?v=' . $this->_amazon->version);
        }
    ...
    public function tabHeader()
    {
        ...
        $smarty->assign('import_enhancement_url', $this->url . 'functions/orders/import_selection.php');
