...
class ProductsAmazon extends AdminTab
{
    ...
    public function __construct()
    {
        ...
        $this->name = Module::getInstanceByName('amazon');
    }
    ...
    public function display()
    {
        ...
        $this->addJS($this->url.'views/js/products.js?v=' . $this->module->version);
        $this->addJS($this->url.'views/js/reports.js?v=' . $this->module->version);
        $this->addJS($this->url.'views/js/automaton.js?v=' . $this->module->version);
