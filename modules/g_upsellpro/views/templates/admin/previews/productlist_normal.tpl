...
{if $gupsellproducts}
    ...
    {/if}
    <div class="gupsellpro-box{if $version17} gps17 {else} gps16 {/if} {if isset($ajaxcal) && $ajaxcal}gupsell_products_ajax{/if} " data-gupsell-id="{$upsellObj->id_g_upsellrule|escape:'html':'UTF-8'}">
