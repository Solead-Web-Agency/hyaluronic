...
{if $gupsellproducts}
    ...
    {/if}
    <div class="gupsellpro-box{if $version17} gps17 {/if}" data-gupsell-id="{$upsellObj->id_g_upsellrule|escape:'html':'UTF-8'}">
        <section class="page-product-box gupsellpro gupsellpro17 gps17 {if isset($ajaxcal) && $ajaxcal}gupsell_products_ajax{/if} gupsellbox-allproducts gupsellbox-checkproducts" id="gupsellpro-{$upsellObj->id_g_upsellrule|escape:'html':'UTF-8'}" data-gupsell-id="{$upsellObj->id_g_upsellrule|escape:'html':'UTF-8'}">
            ...
            <div class="gnone" style="display: none">
                ...
                <input class="gupsell-showin" value="{$showin|escape:'html':'UTF-8'}" type="hidden"  />
            </div>
            ...
            <div class="gupsellpro_volume gupsellbox products">
                {foreach from=$gupsellproducts key=numberkey item='product' name=product}
                    <div class="item {cycle values="odd,even"} col-xs-12 {if $numberkey == 0} active {/if} {if isset($volumes[$numberkey][$showin]['mostpopular']) &&  $volumes[$numberkey][$showin]['mostpopular']}item_popular{/if}" data-type="volume" data-product-id="{$product.id_product|escape:'html':'UTF-8'}"  for="checkbox-for-{$upsellObj->id_g_upsellrule|escape:'html':'UTF-8'}-{$product.id_product|escape:'html':'UTF-8'}" data-numberkey="{$numberkey|escape:'html':'UTF-8'}" data-showinpage="{$showin|escape:'html':'UTF-8'}">
                        {if isset($volumes[$numberkey][$showin]['mostpopular']) && $volumes[$numberkey][$showin]['mostpopular']}
                            ...
                            <div class="item-contentaction-content-left">
                                <div class="gupsellpro_des">
                                    <div itemprop="name" class="product-name">
                                        <a href="#" title="{$product.name|htmlspecialchars}"><span>{if $volumes[$numberkey][$showin]['minqty'] > 0 }{$volumes[$numberkey][$showin]['minqty']|escape:'html':'UTF-8'}{else}1{/if}</span> {l s='Quantities' mod='g_upsellpro'}</a>
                                    </div>
                                </div>
                                        ...
                                        <div class="input-group extra-touchspin">
                                            <span class="input-group-btn-vertical">
                                                <a href="#"
                                                    ...
                                                    data-field-minqty="{if $volumes[$numberkey][$showin]['minqty'] > 0 }{$volumes[$numberkey][$showin]['minqty']|escape:'html':'UTF-8'}{else}1{/if}"
                                                    ...
                                                    data-showinpage = "{$showin|escape:'html':'UTF-8'}"
                                                    data-proextraid = "{$numberkey|escape:'html':'UTF-8'}"
                                                    data-type = "volume"
                                                >
                                                    -
                                                </a>
                                            </span>
                                            <input type="number" min="{if $volumes[$numberkey][$showin]['minqty'] > 0 }{$volumes[$numberkey][$showin]['minqty']|escape:'html':'UTF-8'}{else}1{/if}" name="gupsellproqty"
                                                class="input-group form-control gupsell_quantity_wanted" value="{if $volumes[$numberkey][$showin]['minqty'] > 0 }{$volumes[$numberkey][$showin]['minqty']|escape:'html':'UTF-8'}{else}1{/if}"
                                                style="border: 1px solid rgb(189, 194, 201);" data-field-minqty="{if $volumes[$numberkey][$showin]['minqty'] > 0 }{$volumes[$numberkey][$showin]['minqty']|escape:'html':'UTF-8'}{else}1{/if}"
                                                data-gupsell-id="{$upsellObj->id_g_upsellrule|escape:'html':'UTF-8'}"
                        ...
                        <div class="gupsellpro_price content_price product-price-and-shipping">
                            {hook h='displayProductPriceBlock' product=$product type="before_price"}
                                {if isset($volumes[0][$showin]['discount']) && $volumes[0][$showin]['discount'] > 0}
                                    <span class="gupselldiscount">
                                        {l s='SAVE ' mod='g_upsellpro'}
                                        <div class="gupselldiscount-amount-action-label">
                                            {if $volumes[$numberkey][$showin]['discounttype'] == 1}
                                                {$volumes[$numberkey][$showin]['discount']|escape:'html':'UTF-8'}%
                                            {else}
                                                {Tools::displayPrice($volumes[$numberkey][$showin]['discount'])|escape:'html':'UTF-8'}
                                                <small>
                                                </small>
                                            {/if}
                                        </div>
                            ...
                            <div class="bundle_price_box">
                                <span itemprop="price" class="content_price_label">
                                    {if !$priceDisplay}
                                        {Tools::displayPrice($gupsellvolumeprices[$numberkey]['price_new'])|escape:'html':'UTF-8'}
                                    {else}
                                        {Tools::displayPrice($gupsellvolumeprices[$numberkey]['price_tax_exc_new'])|escape:'html':'UTF-8'}
                                    {/if}
                                </span>
                                ...
                                <div class="gupsell-totalprice-box">
                                    ...
                                    <div class="gupsell-Price-text">
                                        <span class="price-product-price">
                                            {if !$priceDisplay}
                                                {Tools::displayPrice($gupsellvolumeprices[0]['price_new'])|escape:'html':'UTF-8'}
                                            {else}
                                                {Tools::displayPrice($gupsellvolumeprices[0]['price_tax_exc_new'])|escape:'html':'UTF-8'}
                                            {/if}
                                        </span>
                                        ...
                                        {if isset($volumes[0][$showin]['discount']) && $volumes[0][$showin]['discount'] > 0}
                                            <span class="gupselldiscount">
                                                {l s='SAVE ' mod='g_upsellpro'}
                                                <div class="gupselldiscount-amount-action-label">
                                                    {if $volumes[0][$showin]['discounttype'] == 1}
                                                        {$volumes[0][$showin]['discount']|escape:'html':'UTF-8'}%
                                                    {else}
                                                        {Tools::displayPrice($volumes[0][$showin]['discount'])|escape:'html':'UTF-8'}
                                                        <small>
                                                        </small>
                                                    {/if}
                                                </div>
