...
{foreach from=$gupsellproducts item='product' name=product}
    {if $type_template == 'normal'}
        ...
        <div class="gupsellpro_image">
            ...
            <div class="warp-upsellcheckbox-cart" style="display:none">
                        ...
                        <span class="gupselldiscount">
                            ...
                            <div class="gupselldiscount-amount-action-label">
                                {if $upsellObj->type_discount == 1}
                                    {$amountdiscount|escape:'html':'UTF-8'}{l s='%' mod='g_upsellpro'}
                                {else}
    ...
    {elseif $type_template == 'volume'}
        ...
        <div class="item-contentaction">
            <div class="item-contentaction-content-left">
                <div class="gupsellpro_des">
                    <div itemprop="name" class="product-name">
                        <a href="#" title="{$product.name|htmlspecialchars}"><span>{if $qty > 0 }{$qty|escape:'html':'UTF-8'}{else}1{/if}</span> {l s='Quantities' mod='g_upsellpro'}</a>
                    </div>
                </div>
                <div class="gupsellpro-variants">
                    {if !empty($product['AttributesGroups'])}
                    ...
                    <div class="gupsell-qty">
                        <div class="input-group extra-touchspin">
                            ...
                            <input type="number" min="{if $volumes[$numberkey][$showin]['minqty'] > 0 }{$volumes[$numberkey][$showin]['minqty']|escape:'html':'UTF-8'}{else}1{/if}" name="gupsellproqty"
                                class="input-group form-control gupsell_quantity_wanted" value="{if $qty > 0 }{$qty|escape:'html':'UTF-8'}{else}1{/if}"
