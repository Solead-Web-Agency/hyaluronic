...
{if $gupsellproducts}
    ...
    {/if}
    <div class="gupsellpro-box{if $version17} gps17 {else} gps16 {/if} {if $html_template == 'floating'}floating-product-box-show-product gnone{/if} {if isset($ajaxcal) && $ajaxcal}gupsell_products_ajax{/if} " data-gupsell-id="{$upsellObj->id_g_upsellrule|escape:'html':'UTF-8'}">
        <section class="page-product-box gupsellpro gupsellpro17 gupsellbox-allproducts gupsellbox-checkproducts" id="gupsellpro-{$upsellObj->id_g_upsellrule|escape:'html':'UTF-8'}" data-gupsell-id="{$upsellObj->id_g_upsellrule|escape:'html':'UTF-8'}">
            ...
            <div class="gupsellpro_normal gupsellbox products">
                {foreach from=$gupsellproducts item='product' name=product}
                    <div class="item {cycle values="odd,even"} col-xs-12 {if $mostpopular == $product.id_product}item_popular{/if}" data-type="normal" data-product-id="{$product.id_product|escape:'html':'UTF-8'}">
        ...
        {if $html_template == 'floating'}
            <div class="upsel-footer-floating">
                <div class="upsel-footer-floating-title-checkout gnone">
                    <a type="button" class="btn gupsellbtn gupsellbtn-default" href="{$cart_show|escape:'html':'UTF-8'}">
                        {$getConfigFieldsValues['GSELL_SETTING_BUTTON_CHECKOUT'][$id_lang]|escape:'html':'UTF-8'}
                        <i class="pull-right">→</i>
                    </a>
                </div>
                <div class="upsel-footer-floating-title">
                    <span>
                        {l s='Reveal Offers' mod='g_upsellpro'}
                    </span>
                </div>
            </div>
        {/if}
    ...
    {if $html_template == 'popup'}
                <div class="gupsellfooter-popup gupselltext-center">
                    ...
                    <div class="button-footer-popup">
                        <button class="btn gupsellbtn gupsell-close-fancybox-btn">{$getConfigFieldsValues['GSELL_SETTING_BUTTON_NOTHANKS'][$id_lang]|escape:'html':'UTF-8'}</button>
                        <a type="button" class="btn gupsellbtn gupsellbtn-default gnone" href="{$cart_show|escape:'html':'UTF-8'}">
                        {$getConfigFieldsValues['GSELL_SETTING_BUTTON_CHECKOUT'][$id_lang]|escape:'html':'UTF-8'} <i class="pull-right">→</i></a>
                    </div>
                </div>
            </div>
        </div>
