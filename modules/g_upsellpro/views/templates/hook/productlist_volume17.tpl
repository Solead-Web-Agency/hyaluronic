...
{if $gupsellproducts}
                                ...
                                <span class="gupselldiscount">
                                    ...
                                    <div class="gupselldiscount-amount-action-label">
                                        {if $volumes[$numberkey][$showin]['discounttype'] == 1}
                                            {$volumes[$numberkey][$showin]['discount']|escape:'html':'UTF-8'} {l s='%' mod='g_upsellpro'}
                                        {else}
    ...
    {if $html_template == 'popup'}
                ...
                <div class="upsellpopup-prev-action">
                    <div class="upsellpopup-prev-back">
                    </div>
                    <div class="upsellpopup-prev-next">
                    </div>
                </div>
            </div>
        </div>
