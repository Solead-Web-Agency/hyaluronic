 ...
 *                             Precision Insights.
 * @property bool $isAnonymousProxy *Deprecated.* Please see our GeoIP2
 ...
 * @property bool $isLegitimateProxy This attribute is true if MaxMind
 ...
 *                               Insights.
 * @property bool $isSatelliteProvider *Deprecated.* Due to the
 ...
 * @property float|null $staticIPScore An indicator of how static or
 *                                     dynamic an IP address is. This property is only available from GeoIP2
 *                                     Precision Insights.
 * @property int|null $userCount The estimated number of users sharing
