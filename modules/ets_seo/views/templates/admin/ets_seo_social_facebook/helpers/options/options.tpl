        ...
        {if $field['name'] == 'ETS_SEO_FACEBOOK_FP_IMG_URL' || $field['name'] == 'ETS_SEO_FACEBOOK_DEFULT_IMG_URL'}
            ...
            <div class="col-lg-9 col-lg-offset-3 offset-lg-3">
                <div class="ets-seo-img-logo">
                    ...
                    <img src="{$ets_seo_link_img|escape:'quotes'}{$field['value']|escape:'html':'UTF-8'}" class="ets-seo-img-logo-load" onerror="etsSeoLogoError(this)" data-name="{$field['name']|escape:'html':'UTF-8'}">
                </div>
            </div>
            {/if}
        {/if}
