	...
	<div class="tab-content ets_seo_categories">
		<ul class="nav nav-tabs ets_seo_extra_tabs" role="tablist">
			<li role="presentation" class="active">
				<a href="#ets_seo_content_tabs" class="js-ets-seo-tab-customize" data-tab="js-ets-seo-tab-content"  role="tab" data-toggle="tab">{l s='Content' mod='ets_seo'}</a>
			</li>
			<li role="presentation">
				<a href="#ets_seo_setting_tabs" class="js-ets-seo-tab-customize" data-tab="js-ets-seo-tab-setting" role="tab" data-toggle="tab">{l s='Seo settings' mod='ets_seo'}</a>
			</li>
			<li role="presentation">
				<a href="#ets_seo_analysis_tabs" class="js-ets-seo-tab-customize" data-tab="js-ets-seo-tab-analysis" role="tab" data-toggle="tab">{l s='Seo analysis' mod='ets_seo'}</a>
			</li>
		</ul>
		{$smarty.block.parent}
...
{block name='footer'}
	...
	<div class="ets-seo-customize-item js-ets-seo-customize-item js-ets-seo-tab-analysis">
		<div class="form-wrapper">
			<div class="row">
				<div class="col-lg-9">
					{$ets_supplier_seo_analysis_html nofilter}
				</div>
			</div>
		</div>
	</div>
