...
<div class="bootstrap">
	<form class="form-horizontal col-xs-12" action="{$sURI|escape:'htmlall':'UTF-8'}" method="post" id="bt_basics-form" name="bt_basics-form" {if $smarty.const._GMCP_USE_JS == true}onsubmit="javascript: oGmcPro.form('bt_basics-form', '{$sURI|escape:'htmlall':'UTF-8'}', null, 'bt_basics-settings', 'bt_basics-settings', false, false, oBasicCallBack, 'Basics', 'loadingBasicsDiv');return false;"{/if}>
		...
		<div class="form-group">
			...
			<a class="badge badge-info pulse pulse2 pulse pulse2" href="{$smarty.const._GMCP_BT_FAQ_MAIN_URL|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/faq/204" target="_blank"><i class="icon icon-link"></i>&nbsp;{l s='FAQ about shop\'s URL' mod='gmerchantcenterpro'}</a>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-md-5 col-lg-6">
				...
				<a class="badge badge-info pulse pulse2" href="{$smarty.const._GMCP_BT_FAQ_MAIN_URL|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/faq/267" target="_blank"><i class="icon icon-link"></i>&nbsp;{l s='FAQ about simple ID' mod='gmerchantcenterpro'}</a>
			</div>
		</div>

		<div class="form-group" id="bt_prefix_string">
			<label class="control-label col-xs-12 col-md-3 col-lg-3">
				<span class="label-tooltip" title="{l s='Enter a short prefix that represents your shop. For example, if your shop is called "Janes\'s Flowers", enter "jf". This prefix is mandatory and must be unique for each of your shops.' mod='gmerchantcenterpro'}"><b>{l s='Product ID prefix for your shop :' mod='gmerchantcenterpro'}</b></span></label>
			<div class="col-xs-12 col-md-3 col-lg-2">
				<input type="text" id="prefix-id" name="bt_prefix-id" value="{$sPrefixId|escape:'htmlall':'UTF-8'}" />
			</div>
			<span class="icon-question-sign label-tooltip" title="{l s='Enter a short prefix that represents your shop. For example, if your shop is called "Janes\'s Flowers", enter "jf". This prefix is mandatory and must be unique for each of your shops.' mod='gmerchantcenterpro'}">&nbsp;</span>
			<a class="badge badge-info pulse pulse2" href="{$smarty.const._GMCP_BT_FAQ_MAIN_URL|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/faq/194" target="_blank"><i class="icon icon-link"></i>&nbsp;{l s='FAQ about product ID' mod='gmerchantcenterpro'}</a>
		</div>

		<div class="form-group">
			<label class="control-label col-xs-12 col-md-3 col-lg-3">
				<span class="label-tooltip" title="{l s='This determines how many products are processed per AJAX / CRON cycle. Default is 200. Only increase this value if you have a large shop and run into problems with server limits. Otherwise, leave it at its default 200 value. It should not be higher than 1000 in any case.' mod='gmerchantcenterpro'}"><b>{l s='Number of products per cycle :' mod='gmerchantcenterpro'}</b></span></label>
			<div class="col-xs-12 col-md-3 col-lg-2">
				<input type="text" name="bt_ajax-cycle" value="{$iProductPerCycle|intval}" />
			</div>
			<span class="icon-question-sign label-tooltip" title="{l s='This determines how many products are processed per AJAX / CRON cycle. Default is 200. Only increase this value if you have a large shop and run into problems with server limits. Otherwise, leave it at its default 200 value. It should not be higher than 1000 in any case.' mod='gmerchantcenterpro'}">&nbsp;</span>
		</div>

		<div class="form-group">
			<label class="control-label col-xs-12 col-md-3 col-lg-3">
				<span class="label-tooltip" title="{l s='Choose the largest image size available (such as thickbox). Google requires at least 250x250 and recommends at least 400x400 pixels.' mod='gmerchantcenterpro'}"><b>{l s='Image size for product photos :' mod='gmerchantcenterpro'}</b></span></label>
			<div class="col-xs-12 col-md-3 col-lg-2">
			...
			<div>
				<span class="icon-question-sign label-tooltip" title="{l s='Choose the largest image size available (such as thickbox). Google requires at least 250x250 and recommends at least 400x400 pixels.' mod='gmerchantcenterpro'}">&nbsp;</span>
				<a class="badge badge-info pulse pulse2" href="{$smarty.const._GMCP_BT_FAQ_MAIN_URL|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/faq/203" target="_blank"><i class="icon icon-link"></i>&nbsp;{l s='FAQ about image size' mod='gmerchantcenterpro'}</a>
			</div>
		</div>

		<div class="form-group">
			<label class="control-label col-xs-12 col-md-3 col-lg-3"><span class="label-tooltip" data-toggle="tooltip" title data-original-title="{l s='If you want to export only the cover image select "NO"' mod='gmerchantcenterpro'}"><b>{l s='Do you want to export additional images?' mod='gmerchantcenterpro'}</b></span></label>
			<div class="col-xs-5 col-md-5 col-lg-6">
				...
				<span class="label-tooltip" data-toggle="tooltip" title data-original-title="{l s='If you want to export only the cover image select "NO"' mod='gmerchantcenterpro'}">&nbsp;<span class="icon-question-sign"></span>&nbsp;</span>
				</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-5 col-md-5 col-lg-6">
				...
				<span class="label-tooltip" data-toggle="tooltip" title data-original-title="{l s='If you want to force the identifier_exists tag select YES' mod='gmerchantcenterpro'}">&nbsp;<span class="icon-question-sign"></span>&nbsp;</span>
				<a class="badge badge-info" href="{$smarty.const._GMCP_BT_FAQ_MAIN_URL|escape:'htmlall':'UTF-8'}faq.php?id=72&lg={$sFaqLang|escape:'htmlall':'UTF-8'}" target="_blank"><i class="icon icon-link"></i>&nbsp;{l s='How to manage the identifier_exists tag?' mod='gmerchantcenterpro'}</a>
			</div>
		</div>

		<div class="form-group">
			<label class="control-label col-xs-12 col-md-3 col-lg-3">
				<span class="label-tooltip" title="{l s='Please select the category that is the starting point of your tree view (it\'s usually your root or home category)' mod='gmerchantcenterpro'}"><b>{l s='Please select your "Home" category :' mod='gmerchantcenterpro'}</b></span>
			</label>
			<div class="col-xs-12 col-md-3 col-lg-2">
		...
		<div class="form-group">
			...
			<div>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<span class="icon-question-sign label-tooltip" title="{l s='For example "Electronic" or "Clothing". In most cases, the product path will correctly be retreived. But, for security reasons, in case where the product parent category wouldn\'t be found, the module needs to have a replacement value to enter in place of it. This value will then allow you to easily find, in your Google AdWords account, the products concerned.' mod='gmerchantcenterpro'}">&nbsp;</span>
				<a class="badge badge-info pulse pulse2" href="{$smarty.const._GMCP_BT_FAQ_MAIN_URL|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/faq/211" target="_blank"><i class="icon icon-link"></i>&nbsp;{l s='FAQ about product type' mod='gmerchantcenterpro'}</a>
			</div>
		</div>

		<div class="form-group">
			<label class="control-label col-xs-12 col-md-3 col-lg-3"><span class="label-tooltip" data-toggle="tooltip" title data-original-title="{l s='If your shop uses multiple currencies, you have to select "Yes" and modify the robot.txt file as explained in our FAQ (see link opposite)' mod='gmerchantcenterpro'}"><b>{l s='Does your shop use multiple currencies ?' mod='gmerchantcenterpro'}</b></span></label>
			<div class="col-xs-5 col-md-5 col-lg-6">
				<span class="switch prestashop-switch fixed-width-lg">
				...
				<span class="label-tooltip" data-toggle="tooltip" title data-original-title="{l s='If your shop uses multiple currencies, you have to select "Yes" and modify the robot.txt file as explained in our FAQ (see link opposite)' mod='gmerchantcenterpro'}">&nbsp;<span class="icon-question-sign"></span>&nbsp;</span>
				<a class="badge badge-info pulse pulse2" href="{$smarty.const._GMCP_BT_FAQ_MAIN_URL|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/faq/34" target="_blank"><i class="icon icon-link">&nbsp;</i>{l s='FAQ about robot.txt file' mod='gmerchantcenterpro'}</a>
			</div>
		</div>

		<div class="form-group">
			<label class="control-label col-xs-12 col-md-3 col-lg-3">
				<span class="label-tooltip" title="{l s='In most cases, the product condition will correctly be retreived. But, for security reasons, in case where it wouldn\'t be found, the module needs to have a replacement value to enter in place of it. The products concerned will have this condition in your Google AdWords account.' mod='gmerchantcenterpro'}"><b>{l s='In general, what\'s your products condition ?' mod='gmerchantcenterpro'}</b></span></label>
			<div class="col-xs-12 col-md-3 col-lg-2">
			...
			<div>
				<span class="icon-question-sign label-tooltip" title="{l s='In most cases, the product condition will correctly be retreived. But, for security reasons, in case where it wouldn\'t be found, the module needs to have a replacement value to enter in place of it. The products concerned will have this condition in your Google AdWords account.' mod='gmerchantcenterpro'}">&nbsp;</span>
				<a class="badge badge-info pulse pulse2" href="{$smarty.const._GMCP_BT_FAQ_MAIN_URL|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/faq/195" target="_blank"><i class="icon icon-link"></i>&nbsp;{l s='FAQ about product condition' mod='gmerchantcenterpro'}</a>
			</div>
		</div>

		<div class="form-group">
			<label class="control-label col-xs-12 col-md-3 col-lg-3">
				<b>{l s='Product title' mod='gmerchantcenterpro'}</b> :
			</label>
			<div class="col-xs-12 col-md-3 col-lg-3">
				<select name="bt_prod-title" id="bt_prod-title">
					<option value="title" {if $sProductTitle == 'title'}selected="selected"{/if}>{l s='Use the product name' mod='gmerchantcenterpro'}</option>
					<option value="meta" {if $sProductTitle == 'meta'}selected="selected"{/if}>{l s='Use the product meta title' mod='gmerchantcenterpro'}</option>
				</select>
			</div>
			<a class="badge badge-info pulse pulse2" href="{$smarty.const._GMCP_BT_FAQ_MAIN_URL|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/faq/210" target="_blank"><i class="icon icon-link"></i>&nbsp;{l s='FAQ about product titles' mod='gmerchantcenterpro'}</a>
		</div>

		<div class="form-group" id="bt_advanced-prod-name-div">
			<label class="control-label col-xs-12 col-md-3 col-lg-3">
				<span class="label-tooltip" title="{l s='We advise you to add either the product category or the product brand in your product titles.'  mod='gmerchantcenterpro'}"><b>{l s='Advanced product title :' mod='gmerchantcenterpro'}</b></span></label>
			<div class="col-xs-12 col-md-3 col-lg-3">
				<select name="bt_advanced-prod-name" id="bt_advanced-prod-name">
					<option value="0" {if $iAdvancedProductName == 0}selected="selected"{/if} >{l s='Just the normal product name' mod='gmerchantcenterpro'}</option>
					<option value="1" {if $iAdvancedProductName == 1}selected="selected"{/if} >{l s='Current category name + Product name' mod='gmerchantcenterpro'}</option>
					<option value="2" {if $iAdvancedProductName == 2}selected="selected"{/if} >{l s='Product name + Current category name' mod='gmerchantcenterpro'}</option>
					<option value="3" {if $iAdvancedProductName == 3}selected="selected"{/if} >{l s='Brand name + Product name' mod='gmerchantcenterpro'}</option>
					<option value="4" {if $iAdvancedProductName == 4}selected="selected"{/if} >{l s='Product name + Brand name' mod='gmerchantcenterpro'}</option>
					<option value="5" {if $iAdvancedProductName == 5}selected="selected"{/if} >{l s='Free field + Product name + Free field' mod='gmerchantcenterpro'}</option>
				</select>
				<br/>
			</div>
			<span class="icon-question-sign label-tooltip" title="{l s='We advise you to add either the product category or the product brand in your product titles.' mod='gmerchantcenterpro'}">&nbsp;</span>
			<a class="badge badge-info pulse pulse2" href="{$smarty.const._GMCP_BT_FAQ_MAIN_URL|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/faq/178" target="_blank"><i class="icon icon-link"></i>&nbsp;{l s='FAQ about advanced product titles' mod='gmerchantcenterpro'}</a>
		</div>
				...
				<div class="col-xs-12 col-md-3 col-lg-8">
					...
					<div class="form-group">
						<label class="control-label col-xs-12 col-md-3 col-lg-1">
							<span><b>{l s='Prefix' mod='gmerchantcenterpro'}</b></span></label>
						<div class="col-xs-12 col-md-3 col-lg-5" >
							{foreach from=$aLangs item=aLang}
								<div id="bt_advanced_prefix_name_{$aLang.id_lang|intval}" class="translatable-field row lang-{$aLang.id_lang|intval}" {if $aLang.id_lang != $iCurrentLang}style="display:none"{/if}>
									<div class="col-xs-9 col-md-9 col-lg-10">
										<input type="text" id="bt_advanced_prefix_name_{$aLang.id_lang|intval}" name="bt_advanced_prefix_name_{$aLang.id_lang|intval}" {if !empty($aProdNamePrefix)}{foreach from=$aProdNamePrefix key=idLang item=sLangTitle}{if $idLang == $aLang.id_lang} value="{$sLangTitle|escape:'htmlall':'UTF-8'}"{/if}{/foreach}{/if}/>
									</div>
									<div class="col-xs-12 col-md-3 col-lg-2">
										<button type="button" class="btn btn-default dropdown-toggle" tabindex="-1" data-toggle="dropdown">{$aLang.iso_code|escape:'htmlall':'UTF-8'}&nbsp;<i class="icon-caret-down"></i></button>
										<ul class="dropdown-menu">
					...
					<div class="form-group">
						<label class="control-label col-xs-12 col-md-3 col-lg-1">
							<span><b>{l s='Suffix' mod='gmerchantcenterpro'}</b></span></label>
						<div class="col-xs-12 col-md-3 col-lg-5" >
							{foreach from=$aLangs item=aLang}
								<div id="bt_advanced_suffix_name_{$aLang.id_lang|intval}" class="translatable-field row lang-{$aLang.id_lang|intval}" {if $aLang.id_lang != $iCurrentLang}style="display:none"{/if}>
									<div class="col-xs-9 col-md-9 col-lg-10">
										<input type="text" id="bt_advanced_suffix_name_{$aLang.id_lang|intval}" name="bt_advanced_suffix_name_{$aLang.id_lang|intval}" {if !empty($aProdNameSuffix)}{foreach from=$aProdNameSuffix key=idLang item=sLangTitle}{if $idLang == $aLang.id_lang} value="{$sLangTitle|escape:'htmlall':'UTF-8'}"{/if}{/foreach}{/if}/>
									</div>
									<div class="col-xs-12 col-md-3 col-lg-2">
										<button type="button" class="btn btn-default dropdown-toggle" tabindex="-1" data-toggle="dropdown">{$aLang.iso_code|escape:'htmlall':'UTF-8'}&nbsp;<i class="icon-caret-down"></i></button>
										<ul class="dropdown-menu">
		...
		<div class="form-group">
			<label class="control-label col-xs-12 col-md-3 col-lg-3">
				<span class="label-tooltip" title="{l s='Be careful : Google will refuse your product feed if your product titles have too many UPPERCASE letters. So if it\'s the case, choose one of the two solutions suggested in the opposite drag and drop menu.'  mod='gmerchantcenterpro'}"><b>{l s='Do you have too many uppercases in titles ?' mod='gmerchantcenterpro'}</b></span></label>
			<div class="col-xs-12 col-md-3 col-lg-3">
				<select name="bt_advanced-prod-title" id="bt_advanced-prod-title">
					<option value="0" {if $iAdvancedProductTitle == 0}selected="selected"{/if} >{l s='No' mod='gmerchantcenterpro'}</option>
					<option value="1" {if $iAdvancedProductTitle == 1}selected="selected"{/if} >{l s='Yes : Uppercase the first character of each title word' mod='gmerchantcenterpro'}</option>
					<option value="2" {if $iAdvancedProductTitle == 2}selected="selected"{/if} >{l s='Yes : Uppercase the title first character only' mod='gmerchantcenterpro'}</option>
				</select>
			</div>
			<span class="icon-question-sign label-tooltip" title="{l s='Be careful : Google will refuse your product feed if your product titles have too many UPPERCASE letters. So if it\'s the case, choose one of the two solutions suggested in the opposite drag and drop menu.' mod='gmerchantcenterpro'}">&nbsp;</span>
		</div>



		<div class="clr_30"></div>
		<h3 class="subtitle">{l s='Advanced file security' mod='gmerchantcenterpro'}</h3>

		<div class="form-group">
			<label class="control-label col-xs-12 col-md-3 col-lg-3">
				<span class="label-tooltip" title="{l s='This is a security measure so that people from the outside cannot call your feed URL and view your data. For your convenience, we have already automatically generated this secure key during the module installation.' mod='gmerchantcenterpro'}"><b>{l s='Your secure token :' mod='gmerchantcenterpro'}</b></span></label>
			<div class="col-xs-12 col-md-3 col-lg-3">
				<input type="text" maxlength="32" name="bt_feed-token" id="bt_feed-token" value="{$sFeedToken|escape:'htmlall':'UTF-8'}" />
			</div>
			<span class="icon-question-sign label-tooltip" title="{l s='This is a security measure so that people from the outside cannot call your feed URL and view your data. For your convenience, we have already automatically generated this secure key during the module installation.' mod='gmerchantcenterpro'}">&nbsp;</span>
		</div>
		...
		<div class="center">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-1 col-lg-1">
					<button  class="btn btn-info pull-right" onclick="oGmcPro.form('bt_basics-form', '{$sURI|escape:'htmlall':'UTF-8'}', null, 'bt_basics-settings', 'bt_basics-settings', false, false, oBasicCallBack, 'Basics', 'loadingBasicsDiv', false, 1);return false;"><i class="process-icon-save"></i>{l s='Save' mod='gmerchantcenterpro'}</button>
				</div>
			</div>
		</div>
	</form>
