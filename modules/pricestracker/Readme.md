...
1)  Go to your Prestashop administration
2)  Go to Module > Module
3)  Add a module
4)  Upload the zip of this module
5)  Find the module
6)  Click on Install
7)  Click on Configure and set up your paramaters
...
1. This license agreement (hereinafter Agreement) is an agreement between you (the person or company who is being licensed to use the Software or Documentation) and the editor (hereinafter We/us/our). The Agreement applies to all products/software/scripts/services you purchase from us.
...
12. the editor reserves the right to change this license agreement at any time and impose its clauses at any given time.
