    ...
    <div>
        <div id="agWidgetMain" class="agWidget rad" >
            ...
            <div class="reviewCont"> <div class="reviewGlobal">
                <div class="largeNote">
                    <big>{2 * $reviewsAverage|escape:'htmlall':'UTF-8'}</big>/10
                    <p>
                        <br>{l s='Based on' mod='steavisgarantis'} {$nbOfReviews|escape:'htmlall':'UTF-8'} 
                        {if $nbOfReviews == 1}{l s='review' mod='steavisgarantis'}{else}{l s='reviews' mod='steavisgarantis'}{/if}
                    </p>
                </div>
                </div></div>
