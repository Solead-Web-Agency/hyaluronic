...
<div id="agWidgetH" class="inline agWidget rad {$sagLang|escape:'htmlall':'UTF-8'}" style="display:none;">
    <div class="inner rad">
      <a class="agBt rad4" onclick="showReviews(); return false;" href="#ag-s">
        <img src="{$modules_dir|escape:'htmlall':'UTF-8'}steavisgarantis/views/img/{$sagLogoCocarde|escape:'htmlall':'UTF-8'}" class="logoAg" style="width:20px; margin-right:10px; margin-top:5px;">
