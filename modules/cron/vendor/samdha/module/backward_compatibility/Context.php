    ...
    public function __construct()
    {
        ...
        if (is_object($cookie)) {
            ...
            if (defined('_PS_ADMIN_DIR_')) {
                $smarty->ps_language = $this->language;
            }
        } else {
            $this->currency = null;
            $this->language = null;
 ...
 */
if (!class_exists('ShopBackwardModule', false)) {
 ...
 */
if (!class_exists('ControllerBackwardModule', false)) {
 ...
 * Allow to use method declared in 1.5
 */
if (!class_exists('CustomerBackwardModule', false)) {
