...
*}
<p style="font-size: 1.5em; font-weight: bold; padding-bottom: 0"><img src="{$module_path|escape:'htmlall':'UTF-8'}logo.png" alt="{$module_display_name|escape:'htmlall':'UTF-8'}" style="float: left; padding-right: 1em"/>{$module_display_name|escape:'htmlall':'UTF-8'} <abbr title="{samdha_l s='version' mod='samdha'}">v</abbr>{$module_version|escape:'htmlall':'UTF-8'}</p>
