...
function setForceEmailOverlayState(makeInactive) {
    if (makeInactive) {
...
$(document).ready(function () {
    ...
    setForceEmailOverlayState($('[name=TC_move_login_to_account]:checked').val());
    $(document).on('change', '[name=TC_move_login_to_account]', function () {
        setForceEmailOverlayState($('[name=TC_move_login_to_account]:checked').val());
    });
