...
class Carrier68 extends deliveryorderautoupdate\Carrier
{
    public function getResponse()
    {
        ...
        $security = $enseigne.$this->tracking_number.'FR'.$privatekey;
        ...
        xmlns:web="http://www.mondialrelay.fr/webservice/">
           ...
           <soap:Body>
              <web:WSI2_TracingColisDetaille>
                 ...
                 <!--Optional:-->
                 <web:Expedition>'.$this->tracking_number.'</web:Expedition>
                 <!--Optional:-->
    ...
    public function track()
    {
        ...
        if (strpos(',1,24,84,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,', ','.$rsl.',') !== false) {
            ...
            $id_status = TrackingModel::searchIdStatus(68, $status);
            $events = array(
                array(
                    'event_code' => $status,
