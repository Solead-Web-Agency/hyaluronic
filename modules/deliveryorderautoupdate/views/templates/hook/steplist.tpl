...
<div class="step-list {if isset($i)}{$i|escape:'htmlall':'UTF-8'}{/if}" {if isset($i)}data-id="{$i|escape:'htmlall':'UTF-8'}"{/if}>
    ...
    <div class="item-rows">
        ...
        <div class="wrapper step-1"> 
            ...
            <span class="date">{date($date_format_lite, strtotime($steps.order))|escape:'htmlall':'UTF-8'}</span>
        </div>
        ...
        <div class="wrapper step-2">
            ...
            <span class="date">{date($date_format_lite, strtotime($steps.shipped))|escape:'htmlall':'UTF-8'}</span>
        </div>
        {/if}
        {if $steps.current}
        <div class="wrapper current_status step-3">
            ...
            <span class="date">{date($date_format_lite, strtotime($steps.current))|escape:'htmlall':'UTF-8'}</span>
        </div>
        {/if}
