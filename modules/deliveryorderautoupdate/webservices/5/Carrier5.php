...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://gls-group.eu/public/v1/tracking/references/'.$tracking_number,
...
$file_webcarrier = dirname(__FILE__).'/steps5.xml';
...
$events = array_map(function ($e) use ($webxml_crr) {
    return array(
        ...
        'event_description' => '',
        'event_date' => '',
        'id_status' => TrackingModel::getIdStatusByCarrierCode($webxml_crr, (string)$e['code'])
    );
}, $history);
