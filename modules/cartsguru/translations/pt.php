...
. 'Sua solução multicanal para recuperar carrinhos de compra abandonados de maneira fácil. '
. 'Use o retargeting com Emails, SMS, Ligações e Redes Sociais!';
...
. 'A imagem do produto para o Carts Guru foi gerada com sucesso.';
// Product image error
$_MODULE['<{cartsguru}prestashop>cartsguru_497295a4b41a60552bb2b03cd16164ef'] = ''
. 'Somente parte das imagens foram geradas. O servidor foi interrompido antes de terminá-lo.';
// Sign up error
$_MODULE['<{cartsguru}prestashop>cartsguru_52b766c02af601d61d77774a0fa83b22'] = ''
. 'Ocorreu um erro durante seu registro. '
. 'Por favor, entre em contato conosco através do https://carts.guru?platform=prestashop';
$_MODULE['<{cartsguru}prestashop>cartsguru_a33c92bc6fb01f41a3bc7b00f8f75074'] = ''
. 'Ainda não somos compatíveis com seu país. '
. 'Por favor, entre em contato através do https://carts.guru?platform=prestashop';
...
. 'Este domínio já está associado a uma conta';
// Sign in error
...
. 'A melhor maneira de recuperar carrinhos abandonados';
$_MODULE['<{cartsguru}prestashop>welcome_44791981f8a25f9c63c43ba4d979b898'] = ''
. 'Carts Guru é a solução multifuncional para recuperar seus carrinhos abandonados. '
. 'Use Emails, SMS, Ligações Automáticas, Facebook e Instagram para converter mais de 20% dos seus '
. 'clientes perdidos em vendas.';
$_MODULE['<{cartsguru}prestashop>welcome_9a7342bdc64a7abd154cd3227c40cd11'] = ''
. 'Todas as funcionalidades durante seu Teste Grátis de 10 dias / US$5.000 recuperados';
...
. 'Crie campanhas ilimitadas, com ações ilimitadas';
$_MODULE['<{cartsguru}prestashop>welcome_b97da5945c83ba339a75eebc78e53d24'] = ''
. 'Solução fácil de usar e incrivelmente intuitiva';
$_MODULE['<{cartsguru}prestashop>welcome_a389c7d8e2f7b3442deccd1310e3146a'] = ''
. 'Sem riscos, sem de cartão. Cancele quando quiser';
...
. 'Guarde-as para os produtos e clientes mais importantes. Entre em contato automaticamente.';
...
. 'Personalize as campanhas com sua marca. Programe os emails para o momento ideal.';
...
. 'Com uma incrível abertura de 97%. Coloque o Marketing com SMS no seu mix.';
...
. 'Esteja onde seus compradores mais estão. Use o retargeting dinâmico para recuperá-los.';
...
. 'Você está a um passo do seu teste grátis';
...
. 'A senha deve conter de 7 a 64 símbolos, pelo menos um dígito e pelo menos uma letr';
...
. 'A opção de múltiplas lojas está ativada. Se quiser configurar o módulo, por favor, selecione a loja.';

/* welcome.tpl - connect store view */
$_MODULE['<{cartsguru}prestashop>welcome_2f3f00178ef7de520b79a3ccd70f9447'] = ''
. 'Conecte o Carts Guru a sua loja PrestaShop';
