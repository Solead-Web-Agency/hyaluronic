...
. 'Tu solución multicanal para recuperar carritos de compra abandonados de manera fácil. '
. 'Usa el Retargeting con Correos, SMS, Llamadas y Redes Sociales.';
...
. 'La imagen de producto para Carts Guru ha sido generada correctamente.';
// Product image error
$_MODULE['<{cartsguru}prestashop>cartsguru_497295a4b41a60552bb2b03cd16164ef'] = ''
. 'Solamente parte de las imágenes han sido generadas. El servidor se ha interrumpido antes de terminarlo.';
// Sign up error
$_MODULE['<{cartsguru}prestashop>cartsguru_52b766c02af601d61d77774a0fa83b22'] = ''
. 'Ocurrió un error durante el registro. Por favor, contáctanos a través de https://carts.guru?platform=prestashop';
$_MODULE['<{cartsguru}prestashop>cartsguru_a33c92bc6fb01f41a3bc7b00f8f75074'] = ''
. 'Aún no somos compatibles con tu país. Por favor, contáctanos a través de https://carts.guru?platform=prestashop';
...
. 'Ya existe una cuenta asociada a este dominio';
// Sign in error
$_MODULE['<{cartsguru}prestashop>cartsguru_481d6b8c4898d64f0983a567e344d68d'] = ''
. 'Não foi possível conectá-lo com suas credenciais atuais.';
...
. 'La mejor forma de recuperar tus carritos abandonados';
$_MODULE['<{cartsguru}prestashop>welcome_44791981f8a25f9c63c43ba4d979b898'] = ''
. 'Carts Guru es la solución integral para recuperar tus carritos abandonados y convertirlos en ventas. '
. 'Utiliza correos, SMS, llamadas, Facebook e Instagram para convertir a más del 20% de tus clientes perdidos.';
$_MODULE['<{cartsguru}prestashop>welcome_9a7342bdc64a7abd154cd3227c40cd11'] = ''
. 'Todas las funciones durante tu prueba gratuita de 10 días / 5.000€ recuperados';
...
. 'Lleva a cabo campañas y acciones ilimitadas';
$_MODULE['<{cartsguru}prestashop>welcome_b97da5945c83ba339a75eebc78e53d24'] = ''
. 'Fácil de usar, solución altamente intuitiva';
$_MODULE['<{cartsguru}prestashop>welcome_a389c7d8e2f7b3442deccd1310e3146a'] = ''
. 'Sin riesgos, sin tarjeta. Cancela cuando quieras';
...
. 'Para tus productos y clientes más importantes. Ponte en contacto de forma automática con el cliente.';
...
. 'Personaliza campañas con tu marca. Lánzalas en el momento más adecuado de forma automática.';
...
. 'Añade Marketing por SMS, con una excelente tasa de apertura del 97%';
...
. '¡Llega a tus compradores allá donde estén! Usa retargeting dinámico para recuperar compradores.';
...
. 'Estás a solo un paso de tu prueba gratuita';
...
. 'La contraseña debe contener de 7 a 64 símbolos, al menos un dígito y al menos una letra';
...
. 'La opción de tiendas múltiples está activada. Si quieres configurar tu módulo, por favor, selecciona tu tienda.';

/* welcome.tpl - connect store view */
$_MODULE['<{cartsguru}prestashop>welcome_2f3f00178ef7de520b79a3ccd70f9447'] = ''
. 'Conecta Carts Guru a tu tienda PrestaShop';
