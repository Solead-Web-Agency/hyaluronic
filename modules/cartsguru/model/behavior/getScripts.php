 ...
 */
class GetScripts implements CartsGuru\CartsGuru\Shared\BehaviorInterface
{
    /**
    ...
    {
        Module::getInstanceByName('cartsguru')->log('GetScripts');
        ...
        $content = Configuration::get('CARTS_GURU_REGISTER_SCRIPT_SRC', false, $idShopGroup, $idShop);
        if ($content) {
            $result['scripts'][] = [
                'src' => $content,
            ];
