 ...
 */
class AggregateCart implements CartsGuru\CartsGuru\Shared\BehaviorInterface
{
    private $helper;
    ...
    public function execute($jsonCart)
    {
        Module::getInstanceByName('cartsguru')->log('AggregateCart');

        $idShopGroup = (int) Shop::getContextShopGroupID();
        $idShop = (int) Shop::getContextShopID();

        $url = Configuration::get('CARTS_GURU_HOOKS_CART_URL', null, $idShopGroup, $idShop);
        ...
        $this->helper->postAsync($url, $jsonCart);
    }
}
