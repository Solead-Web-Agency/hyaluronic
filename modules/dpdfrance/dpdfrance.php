 ...
 * @copyright 2020 DPD France S.A.S.
...
class DPDFrance extends CarrierModule
{
    private $config_carrier_relais = array(
        'name'                  => array(   'fr'=>'Livraison en relais Pickup',
                                            'en'=>'Delivery in a DPD Pickup shop',
                                            'es'=>'Entrega en el relé DPD',
                                            'it'=>'Consegna in relè DPD',
                                            'de'=>'Zustellung im Abholrelais DPD'),
        ...
        'range_behavior'        => 1,
        'is_module'             => true,
        'delay'                 => array(   'fr'=>'Livraison 24-48h en France vers plus de 6000 relais Pickup.',
                                            'en'=>'24-48h delivery in one of our 6000 pick-up points.',
                                            'es'=>'Entrega en 24 a 48 horas en una de nuestras 6000 tiendas.',
                                            'it'=>'Consegna in 24 a 48 ore in uno dei nostri 6.000 negozi.',
                                            'de'=>'24-48 Stunden Lieferung in einem unserer 6.000 Geschäften.'),
        'id_zone'               => 1,
    ...
    private $config_carrier_predict = array(
        'name'                  => array(   'fr'=>'Livraison à domicile sur créneau horaire',
                                            'en'=>'Time slot home delivery',
                                            'es'=>'Entraga en franja horaria a domicilio',
                                            'it'=>'Consegna a domicilio in fasce orarie',
                                            'de'=>'Zeitfenster Hauszustellung'),
        'id_tax_rules_group'    => 0,
        'url'                   => 'http://www.dpd.fr/tracex_@',
        'active'                => true,
        'deleted'               => 0,
        ...
        'range_behavior'        => 1,
        'is_module'             => true,
        'delay'                 => array(   'fr'=>'Livraison sur créneau horaire sous 24-48h',
                                            'en'=>'Time slot delivery within 24-48 hours',
                                            'es'=>'Entrega en una franja horaria  en  24/48 horas',
                                            'it'=>'Consegna della fascia oraria entro 24-48 ore',
                                            'de'=>'Zeitfenster-Zustellung innerhalb von 24-48 Stunden'),
        'id_zone'               => 1,
        'shipping_external'     => true,
        'external_module_name'  => 'dpdfrance',
        'need_range'            => true,
    ...
    private $config_carrier_classic = array(
        'name'                  => array(   'fr'=>'Livraison sur lieu de travail',
                                            'en'=>'Delivery to the workplace',
                                            'es'=>'Entrega en el lugar de trabajo',
                                            'it'=>'Consegna sul posto di lavoro',
                                            'de'=>'Lieferung an den Arbeitsplatz'),
        'id_tax_rules_group'    => 0,
        'url'                   => 'http://www.dpd.fr/tracex_@',
        'active'                => true,
        'deleted'               => 0,
    ...
    public $config_carrier_world = array(
        'name'                  => array(   'fr'=>'Livraison internationale par DPD',
                                            'en'=>'International delivery by DPD',
                                            'es'=>'Entrega mundial con la confiabilidad de la red DPD.',
                                            'it'=>'Consegna internazionale tramite DPD',
                                            'de'=>'Internationale Zustellung durch DPD'),
        'id_tax_rules_group'    => 0,
        'url'                   => 'http://www.dpd.fr/tracex_@',
        'active'                => true,
        'deleted'               => 0,
    ...
    public function displayForm()
    {
        if (!extension_loaded('soap')) {
            ...
            $this->context->smarty->assign(array(
                ...
                'optvd'                        => array($this->l('Integrated parcel insurance service (33 € / kg)'), $this->l('Ad Valorem insurance service')),
    ...
    public function hookDisplayBackOfficeHeader($params)
    {
        if ((int) Configuration::get('DPDFRANCE_AUTO_UPDATE')) {
            $cron_url = _MODULE_DIR_.'dpdfrance/cron.php?token='.Tools::hash('dpdfrance/cron').'&employee='.(int) $this->context->employee->id;
    ...
    public function hookDisplayHeader()
    {
        ...
        if ($file == 'order') {
            ...
            $this->context->controller->registerJavascript(
                'module-dpdfrance-js',
                '/modules/'.$this->name.'/views/js/front/dpdfrance_532.js',
    ...
    public static function createCarrier($config, $type)
    {
        ...
        foreach ($languages as $language) {
            if ($language['iso_code']=='fr') {
				$carrier->name[$language['id_lang']]=$config['name'][$language['iso_code']];
