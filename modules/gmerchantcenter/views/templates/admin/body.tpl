...
<div id='{$sModuleName|escape:'htmlall':'UTF-8'}' class="bootstrap form">
	...
	{else}
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-2">
				...
				<div class="list-group workTabs">
					<a id="tab-020" class="list-group-item pointer new-bg">
						<div class="row">
							<div class="col-xs-2">
								<img class="img-responsive" height="20px" width="20px" src="{$smarty.const._GMC_URL_IMG|escape:'htmlall':'UTF-8'}admin/icone-gsa.png" alt="" /> 
							</div>
							<div class="col-xs-10">
								<b>{l s='New!' mod='gmerchantcenter'}</b>
								<br/>
								{l s='Google Shopping Actions' mod='gmerchantcenter'}
							</div>
						</div>
					</a>
				</div>
		...
		{if !empty($bWeightUnitStopExec)}
			<div class="alert alert-danger">
						{l s='You need to have correct weight units set in your back-office. Read the' mod='gmerchantcenter'}<a href="https://support.google.com/merchants/answer/7052112?hl={$sCurrentIso|escape:'htmlall':'UTF-8'}" target="_blank">&nbsp;{l s='Google documentation' mod='gmerchantcenter'}</a>
						{l s='about supported weight units and go to your PrestaShop "Localization" tab -> "Localization", to adjust your weight unit.' mod='gmerchantcenter'}
			</div>
		{/if}
