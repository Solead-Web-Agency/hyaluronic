    ...
    public static function loadGoogleTags()
    {
        return array(
            '_no_available_for_order' => array(
                ...
                'type' => 'notice',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('Products not exported due to the "available for order" option not activated for them', 'module-tools_class') . '.',
                'faq_id' => 0,
                'anchor' => ''
            ),
            '_no_product_name' => array(
                ...
                'type' => 'error',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('Products not exported due to missing the product name', 'module-tools_class') . '.',
                'faq_id' => 0,
                'anchor' => ''
            ),
            '_no_required_data' => array(
                ...
                'type' => 'error',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('Products not exported due to missing one of these information: product name or product description or product URL or URL image link', 'module-tools_class') . '.',
                'faq_id' => 0,
                'anchor' => ''
            ),
            '_no_export_no_supplier_ref' => array(
                ...
                'type' => 'notice',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('Products not exported due to missing supplier reference and Unique Product Identifier settings', 'module-tools_class') . '.',
                'faq_id' => 22,
                'anchor' => ''
            ),
            '_no_export_no_ean_upc' => array(
                ...
                'type' => 'notice',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('Products not exported due to missing EAN / UPC and Unique Product Identifier settings', 'module-tools_class') . '.',
                'faq_id' => 22,
                'anchor' => ''
            ),
            ...
            'excluded' => array(
                ...
                'type' => 'notice',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('this product or combination has been excluded from your feed as you define it in the exclusion rules tab', 'module-tools_class') . '.',
                'faq_id' => 0,
                'anchor' => ''
            ),
            'id' => array(
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => GMerchantCenter::$oModule->l('tag "ID" => The identifier for each item has to be unique within your account, and cannot be re-used between feeds', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'prod_id'
            ),
            'title' => array(
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => GMerchantCenter::$oModule->l('tag "TITLE" => This is the name of your item which is required', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'title'
            ),
            'description' => array(
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => GMerchantCenter::$oModule->l('tag "DESCRIPTION" => Include only information relevant to the item, but be comprehensive since we use this text to find your item', 'module-tools_class') . '.',
                'faq_id' => 100,
            ...
            'google_product_category' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "GOOGLE PRODUCT CATEGORY" => The Google product category attribute indicates the category of the product being submitted, according to the Google product taxonomy', 'module-tools_class') . '.',
                'faq_id' => 100,
            ...
            'product_type' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "PRODUCT TYPE" => This attribute also indicates the category of the product being submitted, but you can provide your own classification.', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'prod_type'
            ),
            'link' => array(
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => GMerchantCenter::$oModule->l('tag "LINK" => The user is sent to this URL when your item is clicked on Google Shopping. We also refer to this as the landing page', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'prod_link'
            ),
            'image_link' => array(
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => GMerchantCenter::$oModule->l('tag "IMAGE LINK" => This is the URL of an associated image for a product. Submit full-size images for your products and do not submit thumbnail versions of the images', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'image_link'
            ),
            'condition' => array(
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => GMerchantCenter::$oModule->l('tag "CONDITION" => There are only three accepted values : "new", "refurbished", "used"', 'module-tools_class') . '.',
                'faq_id' => 100,
            ...
            'availability' => array(
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => GMerchantCenter::$oModule->l('tag "AVAILABILITY" => The availability attribute only has four accepted values : "in stock", "available for order", "out of stock", "preorder"', 'module-tools_class') . '.',
                'faq_id' => 100,
            ...
            'price' => array(
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => GMerchantCenter::$oModule->l('tag "PRICE" => The price of the item has to be the most prominent price on the landing page', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'prod_price'
            ),
            'gtin' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "GTIN" => In this attribute, you will include Global Trade Item Numbers (GTINs) for your products', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'prod_gtin'
            ),
            'brand' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "BRAND" => When to include: Required for all items - except for books, media and custom made goods, or if you\'re providing \'mpn\' and \'gtin\'', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'prod_brand'
            ),
            'mpn' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "MPN" => This code uniquely identifies the product to its manufacturer. In particular, the combination of brand and MPN clearly specifies one product', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'prod_mpn'
            ),
            'adult' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "ADULT" => The adult status assigned to your product listings through the ‘adult’ attribute affects where product listings can show', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'adult'
            ),
            'gender' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "GENDER" => Three predefined values accepted : "male", "female", "unisex"', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'gender'
            ),
            'sizeType' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "SIZE TYPE" => The only accepted values of this attribute are : "maternity", "big and tall", "petite", "plus", "regular"', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'sizeTyp'
            ),
            'sizeSystem' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "SIZE SYSTEM" => The only accepted values of this attribute are defined in the module configuration', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'sizeTyp'
            ),
            'age_group' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "AGE GROUP" => The only accepted values of this attribute are : "adults", "kids", "todler", "infant", "newborn" ', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'age_group'
            ),
            'color' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "COLOR" => This defines the dominant color(s) of an item', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'size_color'
            ),
            'size' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "SIZE" => This indicates the size of a product. You may any provide values which are appropriate to your items', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'size_color'
            ),
            'material' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "MATERIAL" => The material or fabric that a product is made out of', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'pattern'
            ),
            'pattern' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "PATTERN" => The pattern or graphic print featured on a product', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => 'pattern'
            ),
            'item_group_id' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "ITEM GROUP ID" => All items that are color/material/pattern/size variants of the same product must have the same item group id', 'module-tools_class') . '.',
                'faq_id' => 0,
                'anchor' => ''
            ),
            'shipping_weight' => array(
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('tag "SHIPPING WEIGHT" => This is the weight of the product used to calculate the shipping cost of the item. It is required to provide this attribute if you have specified a global shipping rule in Settings that is dependent on shipping weight. Google accept the following units: lb, oz, g, kg (respect the lowercase)', 'module-tools_class') . '.',
                'faq_id' => 100,
            ...
            'shipping' => array(
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => GMerchantCenter::$oModule->l('tag "SHIPPING" => This attribute provides the specific shipping estimate for the product. Providing this attribute for an item overrides the global shipping settings you defined in your Google Merchant Center settings. It is required to provide shipping information for all items either by specifying default shipping values in your Google Merchant Center account settings, or by providing this attribute', 'module-tools_class') . '.',
                'faq_id' => 100,
                'anchor' => ''
            ),
            ...
            'title_length' => array(
                ...
                'type' => 'notice',
                'mandatory' => false,
                'msg' => GMerchantCenter::$oModule->l('Google will still require your product titles to be no more than 150 characters long', 'module-tools_class') . '.',
                'faq_id' => 0,
                'anchor' => ''
            ),
        );
