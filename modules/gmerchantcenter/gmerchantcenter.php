...
class GMerchantCenter extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Google Merchant Center (Google Shopping + Actions)');
        $this->description = $this->l('Export your products on Google Merchant Center. Show them on Google Shopping & partners, manage Shopping Actions orders from PrestaShop');
    ...
    public function updateModule()
    {
        ...
        BT_GmcModuleUpdate::create()->run('orderState');
