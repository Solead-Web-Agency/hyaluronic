...
/* defines API url */
define('_GMC_API_URL', 'https://shopify-api.presta-module.com/');
/* defines confirm tpl */
define('_GMC_TPL_GSA_OVERVIEW', 'shopping-action-overview.tpl');
...
$GLOBALS['GMC_AVAILABLE_COUNTRIES'] = array(
    'en' => array(
        ...
        'GB' => array('currency' => array('EUR', 'KES', 'NGN', 'PAB', 'PKR', 'DZD', 'AOA', 'BYN', 'KHR', 'XAF', 'XOF', 'ETB', 'GHS', 'JOD', 'KZT', 'KWD', 'LBP', 'MGA', 'MUR', 'MAD', 'MZN', 'MMK', 'NPR', 'NIO', 'OMR', 'PYG', 'PEN', 'RON', 'XOF', 'LKR', 'UGX', 'UYU', 'UZS', 'ZMW'), 'taxonomy' => 'en-GB'),
        'US' => array('currency' => array('USD', 'EUR', 'NGN', 'PAB', 'PKR', 'DZD', 'AOA', 'BYN', 'KHR', 'XAF', 'XOF', 'ETB', 'GHS', 'JOD', 'KZT', 'KWD', 'LBP', 'MGA', 'MUR', 'MAD', 'MZN', 'MMK', 'NPR', 'NIO', 'OMR', 'PYG', 'PEN', 'RON', 'XOF', 'LKR', 'UGX', 'UYU' ,'UZS', 'ZMW'), 'taxonomy' => 'en-US'),
	...
	'JP' => array('currency' => array('EUR'), 'taxonomy' => 'en-US')
    ),
    'gb' => array(
    ...
    'ja' => array(
        'JP' => array('currency' => array('EUR'), 'taxonomy' => 'ja-JP')
    ),
    'mx' => array(
