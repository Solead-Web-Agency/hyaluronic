...
<div class="modal fade" id="bridgeProcessModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">{l s='Processing cron: ' mod='bridge'} <span class="cron-name"></span></h4>
      </div>
      <div class="modal-body">
        <div class="loading-step text-center">
          <p>{l s='Loading...' mod='bridge'}</p>
          <i class="icon-refresh icon-spin icon-fw process-loading"></i>
        </div>
        <div class="complete-step hidden text-center">
          {l s='The task is completed. Please see logs tab for more informations.' mod='bridge'}
        </div>
        <div class="error-step hidden text-center">
          <span class="generic-error">
            {l s='The task return an error. Please see logs tab for more informations.' mod='bridge'}
          </span>
