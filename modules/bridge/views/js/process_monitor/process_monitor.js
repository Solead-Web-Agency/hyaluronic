 ...
 */
/*
    globals bridgeProcessMonitorController
 */
var BridgeProcessMonitor = {
    $cronButton: false,
    ...
    launchCron: function (btn) {
        var self = this;
        var $processModal = $("#bridgeProcessModal");
        ...
        $.ajax({
            url: bridgeProcessMonitorController,
            type: 'POST',
            data: {
                ajax: true,
