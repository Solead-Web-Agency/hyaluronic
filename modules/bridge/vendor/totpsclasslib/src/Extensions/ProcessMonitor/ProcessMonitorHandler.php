...
namespace BridgeClasslib\Extensions\ProcessMonitor;

use BridgeClasslib\Extensions\ProcessMonitor\Classes\ProcessMonitorObjectModel;
...
{
    /**
     * @var BridgeProcessMonitorObjectModel $process
     */
    protected $process;
