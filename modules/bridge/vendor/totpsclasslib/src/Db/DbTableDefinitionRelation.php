...
class DbTableDefinitionRelation
{
    ...
    /**
     * @var bridgeObjectModelDefinition
     */
    protected $def;

    /**
     * Register bridgeObjectModelDefinition and the internal ID
     * @param bridgeObjectModelDefinition $def
     * @param string                $id
     */
    ...
    /**
     * Get key value from bridgeObjectModel::$definition['associations'][$this->id]
     * @param string $key
     * @return array|null
     */
