...
{
    /**
     * @var BridgeClasslib\Db\ObjectModelDefinition
     */
    protected $def;
    ...
    /**
     * Register BridgeClasslib\Db\ObjectModelDefinition and table (internal) ID
     * @param BridgeClasslib\Db\ObjectModelDefinition $def
     * @param string                $id
     */
     ...
     * @param BridgeClasslib\Db\DbTable $table
     * @return BridgeClasslib\Db\DbTable
     */
