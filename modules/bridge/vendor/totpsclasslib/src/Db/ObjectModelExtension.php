...
namespace BridgeClasslib\Db;

use BridgeClasslib\Db\ObjectModelDefinition;
use BridgeClasslib\Db\DbTableDefinitionModel;
use BridgeClasslib\Db\DbTableDefinitionRelation;
use BridgeClasslib\Db\DbSchema;
use BridgeClasslib\Db\DbTable;
...
class ObjectModelExtension
{
    ...
    /**
     * @return BridgeClasslib\Db\ObjectModelDefinition (as an array collection object)
     */
    ...
    /**
     * @param BridgeClasslib\Db\DbSchema $schema
     * @return bool
     */
