            ...
            <div id="{$option.id}-container" class="payment-option clearfix">
              ...
              <span class="custom-radio float-xs-left">
                ...
                <input
                        ...
                        id="{$option.id}"
                        data-module-name="{if ''!=$option.module_name}{$option.module_name}{else}{$module_name}{/if}{if $smarty.foreach.multioptions.index>0 && $prev_option_name == $actual_option_name}-{$smarty.foreach.multioptions.index}{/if}"
                        name="payment-option"
                        type="radio"
                        required
