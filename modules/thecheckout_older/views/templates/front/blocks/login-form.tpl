...
{block name='login_form'}
  <div class="offer-login">
    ...
    {elseif ($config->social_login_fb || $config->social_login_google) }
      <div class="social-login" data-trans-or="{l s='OR' mod='thecheckout'}">
        {if $config->social_login_fb && $config->social_login_fb_app_id && $config->social_login_fb_app_secret}
        ...
        {/if}
        {if $config->social_login_google && $config->social_login_google_client_id && $config->social_login_google_client_secret}
