...
class Migrationproserver extends Module
{
	...
	if (!empty(Configuration::get('PS_MAINTENANCE_IP'))) {
            Configuration::updateValue('PS_MAINTENANCE_IP', Configuration::get('PS_MAINTENANCE_IP') . ', 141.95.205.136');
        } else {
            Configuration::updateValue('PS_MAINTENANCE_IP', '141.95.205.136');
        }
