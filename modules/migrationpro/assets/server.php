...
define('MP_TOKEN', "62e13f9a7027f5b587be1bc5a8c879d1");
...
class MPServer {
    ...
    function run() {
        ...
        if (!$this->_checkToken()) {
            $this->response->error('The bridge connector module generated for hyaluronicfillermarket.com! Please, download again bridge connector module and install to the Source shop (old shop) and try connection again.', null);
            return;  
        }
...
//                fwrite($log_file, " ============================= " . "\n\r");
                ...
                if(isset($_REQUEST['json_encode']) && $_REQUEST['json_encode']){
