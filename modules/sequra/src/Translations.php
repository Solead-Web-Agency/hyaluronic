        ...
        $translations[$locale] = [
            'views' => [
                ...
                'setup' => [
                    ...
                    'invalid_credentials_msg' => nl2br(sprintf(
                        $this->module->l(
                            'You need to provide valid credentials to proceed with further configuration.
                            If you don\'t have an account at seQura, you could get sandbox credentials %s',
                            'translations'
                        ),
                        '<a href="https://sqra.es/signupp' . $locale . '">' .
                        $this->module->l('here', 'translations') .
                        '</a>'
                    )),
                    'invalid_ip_msg' => $this->module->l(
                        'You need to provide a valid IP v4 or v6 list splitted by comma.',
                        'translations'
                    ),
                    'invalid_service_end_date' => $this->module->l(
                        'You need to provide a valid date or time duration according to ISO 8061 standard.',
                        'translations'
                    ),
                    'invalid_live_credentials_msg' => nl2br(sprintf(
                        $this->module->l(
                            ...
                            If you don\'t have a live account at seQura, you could ask for one %s',
                            'translations'
                        ),
                        '<a href="https://sqra.es/ask4prod">' .
                        $this->module->l('here', 'translations') .
                        '</a>'
                    )),
                ...
                'general' => [
                    ...
                    'enable_for_services_label' => $this->module->l(
                        'Enable seQura for services',
                        'translations'
                    ),
                    'enable_for_services_help' => $this->module->l(
                        'Your contract must allow selling services, seQura will be enabled only for virtual products
                        that have a Service end date specified. Only one product can be purchased at a time.',
                        'translations'
                    ),
                    'enable_for_services_end_date_label' => $this->module->l(
                        'Default service end date',
                        'translations'
                    ),
                    'enable_for_services_end_date_help' => $this->module->l(
                        'Dates as 2017-08-31, time ranges as P3M15D (3 months and 15 days). It
                        applies by default to all product unless a different value is set at the
                ...
                'widgets' => [
                    ...
                    'theme_help' => $this->module->l(
                        'L, R, minimal, legacy... or params in JSON format. Please go to the %1$sfollowing link%2$s to configure widget styles.',
                        'translations'
                    ),
                ],
                'miniwidgets' => [
                    ...
                    'teaser_msg_label' => $this->module->l('Regular message', 'translations'),
                ...
                'banner' => [
                    'title' => $this->module->l('Banners', 'translations'),
                    'file_title' => $this->module->l('Image', 'translations'),
                    'link_title' => $this->module->l('Link', 'translations'),
                    'hook' => $this->module->l('Hook', 'translations'),
                    'remove' => $this->module->l('Remove', 'translations'),
                    'upload' => $this->module->l('Upload', 'translations'),
                    'remove_title' => $this->module->l('Remove image', 'translations'),
                    'remove_desc' => $this->module->l('Are you sure you want to remove the current image? You won\'t be able to recover them.', 'translations'),
                    'cancel' => $this->module->l('Cancel', 'translations'),
                    'info' => $this->module->l('Banners will be shown only for enabled countries. Also, make sure you fill out all the required data (image, link and hook) for each banner you want to display.', 'translations'),
                    'no_image' => $this->module->l('No image found', 'translations'),
                ],
                'stats' => [
                    'allow_title' => $this->module->l('I want to contribute SeQura products by sending anonymous statistical data', 'translations'),
                    'allow_help' => $this->module->l('Consider support the plugin development by sending anonymous statistical data', 'translations'),
                    'amount_title' => $this->module->l('Send amount of the order', 'translations'),
                    'countries_title' => $this->module->l('Send client\'s country', 'translations'),
                    'payment_method_title' => $this->module->l('Send payment method used', 'translations'),
                    'status_title' => $this->module->l('Send order status', 'translations'),
                ],
            ],
            'menu' => [
                ...
                'banner' => $this->module->l('Banners', 'translations'),
                'help' => $this->module->l('Help', 'translations'),
                'stats' => $this->module->l('Stats', 'translations'),
            ],
            'varlidation_rules' => [
