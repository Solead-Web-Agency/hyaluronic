...
<div class="form-group">
	<label id="sequra_is_service_label" for="sequra_is_service" class="control-label col-lg-3">
		<span>{l s='Is service?:' mod='sequra'}</span>
		<span class="help-box" data-toggle="popover"data-content="{l s='Sequra should deal with this product as a service' mod='sequra'}"></span>
	</label>
	<div class="col-lg-9">
			<span class="switch prestashop-switch fixed-width-lg">
...
<div class="form-group" id="sequra_service_end_date_row">
	<label class="control-label col-lg-3" for="sequra_is_service">
		<span>{l s='Service end date or period' mod='sequra'}:</span>
		<span class="help-box" data-toggle="popover" data-content="{l s='Service end date or period' mod='sequra'}"></span>
	</label>
	<div class="col-lg-2">
		<input type="text"
