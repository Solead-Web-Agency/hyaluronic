...
class AdminCAPTargetController extends ModuleAdminController
{
    ...
    public function ajaxProcessLoadTemplate()
    {
        ...
        exit($this->context->smarty->fetch(_PS_MODULE_DIR_.'/'.$this->module->name.'/views/templates/admin/tabs/reminder_plan/target_frequency.tpl'));
    }
    ...
    public function loadTemplateExistingDatas($reminderId) 
    {
        ...
        $allReminderTargetInformations = $oReminderInfos->getTargetInfos($reminderId);

        $this->context->smarty->assign(array(
            'target_infos' => $allReminderTargetInformations,
        ));
    }
} 
