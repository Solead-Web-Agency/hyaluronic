...
use Vivawallet\VivawalletPhp\Api\AuthenticationClient;
...
class BearerAuthentication implements Authentication
{
    ...
    private function setNewToken($username, $password)
    {
        ...
        $this->response       = $authenticationClient->getBearerToken(
            new BasicAuthentication($username, $password, $this->environment),
            $this->grantType,
            $this->scope
        );
