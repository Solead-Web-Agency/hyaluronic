...
namespace Vivawallet\VivawalletPhp;

class Application
{
    public const VIVAWALLET_ABBREVIATION = 'VW';
    public const SDK_VERSION             = '2.2.5';
    ...
    public const BASE_URLS               = [
        'demo' => [
            ...
            'default'  => 'https://demo.vivapayments.com',
        ],
        'live' => [
            'accounts' => 'https://accounts.vivapayments.com',
            'api'      => 'https://api.vivapayments.com',
            'default'  => 'https://www.vivapayments.com',
        ]
    ];
    public const ENDPOINTS               = [
        'accountsToken'      => '/connect/token',
        'sources'            => '/plugins/v1/sources',
        'webhook'            => '/plugins/v1/webhooks',
        'webhookToken'       => '/plugins/v1/webhooks/token',
        'order'              => '/plugins/v1/orders',
        'pluginOrders'       => '/checkout/v2/orders',
        'merchants'          => '/plugins/v1/merchants',
        'orders'             => '/api/orders',
        'transactions'       => '/checkout/v2/transactions',
        'smartCheckout'      => '/web/checkout',
        'acquiring'          => '/acquiring/v1/transactions',
        'diagnostics'        => '/diagnostics/v1/log',
        'nativeTransactions' => '/nativecheckout/v2/transactions',
        'nativeChargeToken'  => '/nativecheckout/v2/chargetokens',
        'nativeDigitalChargeToken'  => '/nativecheckout/v2/chargetokens:digitize',
    ];
    ...
    public const CHANNEL_IDS               = [
        'prestashop'       => 'A45C1059-C048-471A-95AE-8F5FF92C16F0',
        'shopify'          => '4C09857A-C6E7-4B32-B589-202F323C301E',
        'shopware'         => '7BCA8E85-0413-4FDC-861B-DD17374EED20',
        'woocommerce'      => 'F173274B-3EFD-4AC1-BCFA-A795D2266777',
    ];
    ...
    public static function setInformation(array $information): void
    {
        ...
        self::$information['vivaWallet']['abbreviation'] = $information['vivaWallet']['abbreviation']
            ?? self::VIVAWALLET_ABBREVIATION;
    ...
    public static function getSmartCheckoutUrl(array $params, string $environment): string
    {
        ...
        return implode(
            [
                ...
                $endpoint,
                '?',
                http_build_query($filteredParams)
            ]
        );
    }
}
