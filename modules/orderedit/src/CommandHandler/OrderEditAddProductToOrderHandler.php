...
//namespace PrestaShop\PrestaShop\Adapter\Order\CommandHandler; // #TODO - the original space
namespace OrderEdit\CommandHandler;
...
use PrestaShop\PrestaShop\Adapter\Order\CommandHandler\AddProductToOrderHandler;
 ...
 * @internal
 */
final class OrderEditAddProductToOrderHandler extends AbstractOrderHandler implements AddProductToOrderHandlerInterface
{
    /**
     * @var Context
     */
...
//        $this->assertOrderWasNotShipped($order); // #TODO Only this change in whole file
