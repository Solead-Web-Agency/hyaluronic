...
if (!class_exists('BT_InstallCtrl', false)) {
class BT_InstallCtrl
{
	...
	public static function run($sAction, $sInstallType, $mParam = null)
	{
		...
		if (in_array($sAction, self::$_aDefaultAction)) {
			...
			require_once(_GR_PATH_LIB_INSTALL . 'i-install.php');

			switch ($sInstallType) {
				case 'sql':
					// include matched installation object
					require_once(_GR_PATH_LIB_INSTALL . 'install-sql_class.php');
				...
				case 'config':
					// include matched installation object
					require_once(_GR_PATH_LIB_INSTALL . 'install-config_class.php');
				...
				case 'tab':
					// include matched installation object
					require_once(_GR_PATH_LIB_INSTALL . 'install-tab_class.php');
