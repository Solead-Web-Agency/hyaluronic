...
<div class="bootstrap" id="" style="">
    <div class="alert alert-info" id="">
        <span id="">Map all the Required Claroshop attributes with Prestashop attributes in order to prevent error at the time of product upload</span>
    </div>
</div>
<div class="panel row">
    <div class="panel-body">
        ...
        {foreach $attributeList as $attribute}
            {assign var="attr_code" value="{$attribute['id']|trim|escape:'htmlall':'UTF-8'}" }
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <b>{$attribute['nombre']|escape:'htmlall':'UTF-8'}</b>
                        </br>
                        {$attribute['tipo']|escape:'htmlall':'UTF-8'}
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
