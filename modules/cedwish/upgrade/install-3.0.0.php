...
function upgrade_module_3_0_0($module)
{
    ...
    if ($module) {
        try {
            ...
            } elseif (empty(Db::getInstance()->executeS(
                "SHOW TABLES LIKE '" . _DB_PREFIX_ . "cedwish_profile_old'"
            ))) {
                Db::getInstance()->execute(
                    "RENAME TABLE `" . _DB_PREFIX_ . "cedwish_profile` TO `" . _DB_PREFIX_ . "cedwish_profile_old`"
                );
            ...
            if (empty(Db::getInstance()->executeS(
                "SHOW TABLES LIKE '" . _DB_PREFIX_ . "cedwish_profileproducts_old'"
            ))) {
                $new_pps = array();
