                    ...
                    <div class="row util-links">
                        <div class="col-lg-12">
                            <p>
                                ...
                                <i class="icon-external-link"></i> <a target="_blank" title="Documentación" href="{if isset($doc_url)}{$doc_url|escape:'htmlall':'UTF-8'}{else}{$this_path|escape:'htmlall':'UTF-8'}readme_es.pdf{/if}">Documentación</a><br/><br/>
