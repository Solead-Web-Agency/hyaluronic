...
class Configuration
{
    public $configurations = [
        ...
        'order_state_partial_refund' => [
            'type' => 'integer',
            'name' => 'ORDER_STATE_PARTIAL_REFUND',
            'defaultValue' => null,
            'setConf' => 0,
        ],
        'order_state_partial_refund_test' => [
            'type' => 'integer',
            'name' => 'ORDER_STATE_PARTIAL_REFUND_TEST',
            'defaultValue' => null,
            'setConf' => 0,
        ],
        'payment_methods' => [
