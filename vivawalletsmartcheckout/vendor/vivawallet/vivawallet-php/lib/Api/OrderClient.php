...
use Vivawallet\VivawalletPhp\Api\Request\OrderRequest;
...
class OrderClient
{
    ...
    public function createOrder(
        ...
        return $this->httpClient->request(
            ...
            . Application::ENDPOINTS['pluginOrders'],
            [
                'json'    => OrderRequest::getCreateOrder($amount, $currencyCode, $options),
                'headers' => [
    ...
    public function retrieveOrder(
        ...
        return $this->httpClient->request(
            ...
            . Application::ENDPOINTS['order']
            . (!empty($options['orderCode']) ? "/{$options['orderCode']}" : ''),
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Authorization' => $authentication->getHeader()
