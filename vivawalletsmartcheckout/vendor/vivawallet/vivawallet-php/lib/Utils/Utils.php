...
namespace Vivawallet\VivawalletPhp\Utils;
...
class Utils
{
    ...
    private static function getUserAgentElements(): array
    {
        ...
        $userAgentElements = [
            ($applicationInfo['vivaWallet']['abbreviation'] ?? '') . 'SDK' => Application::SDK_VERSION,
            $applicationInfo['cms']['abbreviation']                        => $applicationInfo['cms']['version'],
            $abbreviationKey                                               => $applicationInfo['vivaWallet']['version'],
        ];
